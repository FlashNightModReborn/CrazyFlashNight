...
**最后核对代码基线**：release source commit `34a944055880f5e150cdf25053fffc4fd238cce7`（2026-09-08，地图主动撤退入口），当前正式 runtime 为 `promoted`。发布身份、共识与验收边界只读 [runtime 构建复现文档](docs/runtime-build-reproducibility.md)。
