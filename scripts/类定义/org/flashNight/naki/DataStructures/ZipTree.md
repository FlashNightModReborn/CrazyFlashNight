...
添加 100 个元素平均耗时: 1.47 毫秒
搜索 100 个元素平均耗时: 1.48 毫秒
移除 100 个元素平均耗时: 1.66 毫秒
buildFromArray(100 个元素)平均耗时: 1.55 毫秒
changeCompareFunctionAndResort(100 个元素)平均耗时: 1.69 毫秒

容量: 1000，执行次数: 10
PASS: 所有元素移除后，size 应为0
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 ZipTree 中
添加 1000 个元素平均耗时: 18.5 毫秒
搜索 1000 个元素平均耗时: 24.3 毫秒
移除 1000 个元素平均耗时: 24.1 毫秒
buildFromArray(1000 个元素)平均耗时: 19 毫秒
changeCompareFunctionAndResort(1000 个元素)平均耗时: 20.2 毫秒

容量: 10000，执行次数: 1
PASS: 所有元素移除后，size 应为0
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 ZipTree 中
添加 10000 个元素平均耗时: 201 毫秒
搜索 10000 个元素平均耗时: 276 毫秒
移除 10000 个元素平均耗时: 259 毫秒
buildFromArray(10000 个元素)平均耗时: 235 毫秒
changeCompareFunctionAndResort(10000 个元素)平均耗时: 231 毫秒
