...
**当前正式发布（2026-08-15）**：装备调制属性前后对比（preview 区 before/after diff 表 + 候选 tooltip 图片栏试算 diff + 紧凑 blocked 候选原因 tooltip 行）release source `167d929a4bc3a85d6d21cc7faa220644eefe01d7`（tag `runtime-build-v2/20260815-equipment-tuning-stats-v1`）、release tree `fd7c371587d39c9aec81c5d71fbaa03143e17652` 与 request `9152583BE0F4E379F157AAA4EB74D56EA6EEF17676D7B18B8984A93E849EEB29` 已完成正式 promotion。本地 X509 `physical-host-a`（keyId `28DBEAF3761CCF3177FE396596A2557D8A6C9393371CD41DC893FF75A02723B3`）与 GitHub OIDC builder `7F1F5D6FAA28D1A308EC7C0D4C9E8B1A4F73AFA775C29480F3F81AEE0277DC7E` / `github-hosted-windows`（run `31881405907`）对 identity `BD3E2D68C98E9EDFBCED8AB9B756A25FF4B15A54C5892169055085257ED9171A` / closure `07C04381D8EB5EE6A37FCC354E12F87931CB16A84B43BF4BC62653AE755FD7A1` 达成双 signer、双 faultDomain 共识；正式 Core SHA-256 为 `7236654F6297BA1FBB5654F0515575C617599CFF7AE45F495C46F429138C175A`，promotion 提交 `9b1fe531b042d53207a0b879de71e394d1de8209` 已推送。本列车为 owner 明确授权的 `owner_emergency_non_h2`（授权 SHA-256 `D2E0894743DFC7146B1E128C929E857FB6CC1BBA8CDAA683CF4C069767B29F00`，bypass=[E1,H2,E3]，保留控制完整）；正式入口复验取得 `runtimeMode=formal_runtime`、Guardian 总线就绪与 identity/closure 精确匹配。AS2 侧由同一 tree 的 `scripts/asLoader.swf`（1,083,795 bytes、SHA-256 `58235B43453385C1B909F2B869900E557B0E2360865B10CD25796B7F07FDE7F9`、9,863 functions）承载，经 fresh 门（equipment-tuning 67/67 + 147/147、compiler 0/0、32K retry 0）与全量 xUnit 3732+3/3735 验证；受影响面板 business smoke 由维护者目视进行，不冒称 `standard_entry_verified`。下行"当前正式发布（2026-08-11）"与更早段落均按历史列车输入阅读，不覆盖本段。
**上一正式发布（2026-08-11，历史明细）**：跨层回包键契约修复（商店购买结算、Loot 快照 balanceSummary 剥离、装备调制 loadout 失败包、角色构筑 reconcile 快照与失败码）release source `a87be26f1d6e80c0ea8883bbc10e46c895c35799`（tag `runtime-build-v2/20260811-cross-layer-wire-contract-v1`）、release tree `32e5b9be67de220eb297e6c568c90546b283c471` 与 request `44A8D5461BE38E0807A7BE1DFEDAD4F5065F7981C590460CAEBAB4153E577A5E` 已完成正式 promotion。无 candidate id 的正式入口复验 `runtimeMode=formal_runtime`、Guardian 总线就绪、Core SHA-256 / build identity / payload closure 与被提升身份一致；AS2 侧修复由同一 tree 的 `scripts/asLoader.swf` 承载，经 fresh trace 门（item-panels NPC 48/48、map-loot 151 断言、equipment-tuning 60/60 + 147/147）与全量 xUnit 3308+3/3311 验证。这些证据不代表物理双屏、物理设备输入、任意业务写或玩家目视签收。下行 P4/P5 与 A1–A6 段只保留为历史记录。
...
当前 consensus 精确绑定 request `9152583BE0F4E379F157AAA4EB74D56EA6EEF17676D7B18B8984A93E849EEB29` 与 release tree `fd7c371587d39c9aec81c5d71fbaa03143e17652`。artifact source 为 `49B14F7BB2711A9859385EC52233D615310F95B225F304EDE9B56987072FA3BF`、producer recipe `93A007D1BD03C54F3CC257F1E4610354BBBB83C97B635AC28C2B5D393C75868A`、toolchain lock `7B83229BE93F8244810CDD23DAFD97875B23857E547DE520035FE23B453CB3CD`、policy `5CB08769DD8CF390B1EBB0DD6339C148A28ACEB7FF171C1742C0BE0F1E611A96`；build identity `BD3E2D68C98E9EDFBCED8AB9B756A25FF4B15A54C5892169055085257ED9171A`、payload closure `07C04381D8EB5EE6A37FCC354E12F87931CB16A84B43BF4BC62653AE755FD7A1`、manifest SHA-256 `7AF54AE4AB6AB8A0254E469BA939F590CDAC95E5552E01D98AFCF044A15016A3`、promotion 后 Windows worktree consensus bytes SHA-256 `62A7F596F4A487ACA4A02F6D81DD71C286B652C201F61CD648FB9303FA4B9065`。production policy receipt SHA-256 为 `C88B6B838CFABCC4090ECF7B0844F2173745C93992861B12D956CE0F8ED3CA94`；本地 X509 signer `28DBEAF3761CCF3177FE396596A2557D8A6C9393371CD41DC893FF75A02723B3` / `physical-host-a` 与 GitHub OIDC builder `7F1F5D6FAA28D1A308EC7C0D4C9E8B1A4F73AFA775C29480F3F81AEE0277DC7E` / `github-hosted-windows`（run `31881405907`）满足双 signer、双 faultDomain、production receipt 与 v2 strict/full-install verifier，于 `2026-08-15T11:33:49.4829577Z` 完成 promotion。

当前正式部署的根 EXE SHA-256 为 `55EABB5C3280FDFEE8302843D969C6B6354808F1AF4DC24DB5E2397AA80499D8`，Core DLL SHA-256 为 `7236654F6297BA1FBB5654F0515575C617599CFF7AE45F495C46F429138C175A`。无 candidate id 的正式入口启动复验取得 `runtimeMode=formal_runtime`、33-file integrity、Guardian 总线就绪与 identity/closure 精确匹配；受影响业务面只取得维护者目视 smoke，未完成 Agent Runtime MCP 窄纵切或装备调制专项正式旅程，因此不声称 `standard_entry_verified`，也不外推任何业务写或玩家目视签收。下行仍以“当前”描述旧 source / identity 的段落均按历史列车输入阅读，不覆盖本段。
