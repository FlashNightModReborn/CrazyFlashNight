...
添加 100 个元素平均耗时: 2.33 毫秒
搜索 100 个元素平均耗时: 0.82 毫秒
移除 100 个元素平均耗时: 1.29 毫秒
buildFromArray(100 个元素)平均耗时: 0.66 毫秒
changeCompareFunctionAndResort(100 个元素)平均耗时: 0.73 毫秒

容量: 1000，执行次数: 10
PASS: 所有元素移除后，size 应为0
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 WAVLTree 中
添加 1000 个元素平均耗时: 33.6 毫秒
搜索 1000 个元素平均耗时: 10 毫秒
移除 1000 个元素平均耗时: 17.9 毫秒
...
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 WAVLTree 中
添加 10000 个元素平均耗时: 435 毫秒
搜索 10000 个元素平均耗时: 145 毫秒
移除 10000 个元素平均耗时: 258 毫秒
buildFromArray(10000 个元素)平均耗时: 55 毫秒
changeCompareFunctionAndResort(10000 个元素)平均耗时: 78 毫秒
