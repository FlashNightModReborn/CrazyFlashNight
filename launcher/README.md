...
#   - 注入 CSS 隐藏 web 端 #safe-exit-panel / #quest-notice-bar / #combo-status / #jukebox-panel 避免双重渲染
...
# 完整 idle SW_HIDE WebView2 推迟到 Phase 4 收尾后（剩余 map-hud widget 迁完）。
useNativeHud = false
```
