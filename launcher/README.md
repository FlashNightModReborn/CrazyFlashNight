...
#     NotchToolbarWidget（PETS/MERCS/TABLET/WAREHOUSE/SHOP，恢复 kshop 入口可达），
...
#       pause 走 webOverlay.ToggleBgmPause 共享 _bgmPaused 镜像；展开按钮调 router JUKEBOX_EXPAND，Phase 5 注册 panel 后启用），
