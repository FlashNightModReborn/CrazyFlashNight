 ...
 *     后续可通过工厂模式装配不同的检测器。
 */
class org.flashNight.arki.bullet.BulletComponent.Lifecycle.NormalLifecycleProcessor extends BulletLifecycleProcessor{
    ...
    public function NormalLifecycleProcessor() {
