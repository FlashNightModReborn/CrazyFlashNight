...
**文档角色**：启动与运行自动化入口。  
**当前正式列车（2026-08-27，关卡结果与基地结算）**：release source `732898b8aa1308cf820976324f47bba97f654e41`、tag `runtime-build-v2/20260827-stage-outcome-settlement-v2`、release tree `d498236a3ac06294f0c871dba73302bb24bc398e` 与 request `CB8268D83DB35DF3BC7D22587822F279C29A93CD12A15B1F10DF14759B000991` 已由本地 X509 `builder-local-a` / `physical-host-a` 与 GitHub OIDC/Sigstore `github-hosted-windows`（cloud run `33070890481`）对 identity `03F9825C2A2A248C73A7FA6FFB4E6C4305D49C4F97BD9E6042747B9BC5A0F5AA`、closure `5DA2B3053BF70EFCDCE74A503C33098774F9026AAD6E2D1F555C1A9EC5181D07` 达成双 signer / 双 faultDomain 共识。39/39 final receipt SHA-256 为 `977B2B2A7466C307198438C1F8362CE9ED06F3415977F664CB4E402B4192A181`；deployment commit `339b15694d631d483736880c0dfd44429f6926a3` 与 post-promotion audit run `33071572650` 均已推送/通过，审计明确输出 `state=promoted`、`deploymentChanged=true`。
无 candidate selector 的正式入口确认 `formal_runtime`、正式 Core `5B010C6040A5E80E1E8923FD02D6B632AB2D309511F8C6A54BA7D78B7516314F`、精确 identity/closure、bus ready、正常 Guardian 关闭与零新增 Flash/WebView2/ports 残留。因为没有选择存档，预热 45 秒 deadline 后以 Flash code 0 安全回收，没有 fresh `bootstrap_reveal_ready`，也没有重跑关卡业务。准确状态为关卡结果与基地结算 `HUMAN_ACCEPTANCE_PASSED / promoted`；本轮正式入口只提供身份、总线和正常退出窄证据，不称业务或完整入口 `standard_entry_verified`。
