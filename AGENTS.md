...
**最后核对代码基线**：面板 tooltip 交互收尾与最小化恢复黑屏修复 source commit `29ab59fd7832d10d54badc3132a5153646c1fa3d`（tag `runtime-build-v2/20260815-overlay-compositor-restore-v2`）、release tree `978eaa7e75708b82fd8d57b9f8c63b11f5e689cb`、request `2EE9A1E09A07A93EE2B7D49D74BCCDFE71A6953E290AB7C8D6A58BC460DAC4A0` 已由本地 X509 `physical-host-b` 与 GitHub OIDC/Sigstore `github-hosted-windows`（cloud run `31892519833`）完成 v2 双 signer/双故障域 promotion；正式 runtime 绑定 identity `74D14EE3A17CD12AE5F74CB6779CF702339E4D22E3F6C6523F1E9C72EFA04CA3`、closure `2F6B950B64441E1378A687549638464D420C255251D517EA935D866021D6D1CC`、Core SHA-256 `73579C43BF6DFDF97B9EC5158A6492BFF3C1AC67357AA5A7D06B3B77BE6F4697`，promotion 提交 `a469f487f065abea7558a89a13f0345ab468d4a6` 与 post-promotion audit run `31897530643` 均已推送/通过。本列车没有 Audio emergency 或 H2 bypass：Audio H2 仍为专项 `pending`，只限制 Audio 的 `e2e_verified` / `standard_entry_verified` 声明；通用发布继续保留 immutable request、production policy、strict v2 verifier、atomic promotion 与 rollback。正式根入口 `--verify-only` 为 `exit 0`，但未执行面板业务专项正式旅程，故当前只称 `promoted`，不冒称 `standard_entry_verified`。此前面板回包最小门 `704d836f42b70f788db8b5b2151c8ab3dcf77792`、Audio Platform v2 emergency `48c312234ab189b16f9edd2f5f7b0b2e78fc1407`、装备调制属性对比 `167d929a4bc3a85d6d21cc7faa220644eefe01d7`、跨层回包键 `a87be26f1d6e80c0ea8883bbc10e46c895c35799`、竞技场 P4/P5、商城旧档、双栏工作台、F8 与 F7 C1 均只保留为历史分层证据。
