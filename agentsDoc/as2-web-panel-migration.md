...
**最后核对代码基线**：commit `730c6be781ddd22bfd7a59a2e7773acce892f105` 已由 tag `runtime-build-v2/20260806-workbench-authority-a1-a6-v2`、release tree `1434e71d44fe41ad0fa426bc857085f1aff940dd`、request `D45D0DEF50E159B8A875DCA922D856BEC69D64A6B779B6B7B7082D68AC6B92CF` 完成 v2 promotion；正式 runtime 绑定 identity `E203E4F06F6701F8B583768145AE64F93D2599238C290DD71FD50A9FBAA7B422`、closure `F606DF4D2B11579121C7122ECB80734053B0BDF39948921C65B0FDC6CB66800F` 与 Core DLL `75F35C025BDE29D4D713671763511B425D1AFA5758DD154931AC0FC5C59C4977`。无 candidate id 的 pure-MCP 正式入口达到 `standard_entry_verified`，范围仅为 Launcher 与 allow-listed Help WebOverlay WGC、strict terminal receipt、supported shutdown、测试存档不变和无新增残留进程；A1–A6 业务 opener/写操作、物理拖拽和玩家目视签收仍由独立 Gate 或后续专项旅程承担，不能由该 smoke 外推。

2026-07-29 的 B7 施工从 commit `c96f4c3d750561022b706c72a4d53050431e627d` 起步；2026-07-30 的历史 cut 又删除仓库、装备、NPC 商店、合成与技能教师的 legacy renderer/fallback，并收口 main XFL 可达闭包。该 cut 的 immutable tag、双故障域 quorum、promotion、成功与失败标准入口证据全部保留，但已由上方 2026-08-06 current release supersede；旧纵切没有执行 Character、Materials、Intelligence、PlayerInfo、业务 preview/commit、普通 panel close 或持久化专项旅程，本次 Help smoke 也不补齐这些业务范围。
