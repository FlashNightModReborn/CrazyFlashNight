...
WAVL违规[不变量4]: 非叶子节点 10 是违规的(2,2)-节点
FAIL: 移除后的树应保持WAVL属性
...
添加 100 个元素平均耗时: 1.92 毫秒
搜索 100 个元素平均耗时: 0.82 毫秒
移除 100 个元素平均耗时: 1.19 毫秒
buildFromArray(100 个元素)平均耗时: 0.64 毫秒
changeCompareFunctionAndResort(100 个元素)平均耗时: 0.8 毫秒
...
搜索 1000 个元素平均耗时: 10.9 毫秒
移除 1000 个元素平均耗时: 16.9 毫秒
buildFromArray(1000 个元素)平均耗时: 6.1 毫秒
changeCompareFunctionAndResort(1000 个元素)平均耗时: 7.7 毫秒
...
搜索 10000 个元素平均耗时: 150 毫秒
移除 10000 个元素平均耗时: 246 毫秒
buildFromArray(10000 个元素)平均耗时: 62 毫秒
changeCompareFunctionAndResort(10000 个元素)平均耗时: 80 毫秒
