...
添加 100 个元素平均耗时: 1.9 毫秒
搜索 100 个元素平均耗时: 0.68 毫秒
移除 100 个元素平均耗时: 1.29 毫秒
buildFromArray(100 个元素)平均耗时: 0.62 毫秒
...
搜索 1000 个元素平均耗时: 10.4 毫秒
移除 1000 个元素平均耗时: 17.3 毫秒
buildFromArray(1000 个元素)平均耗时: 6 毫秒
changeCompareFunctionAndResort(1000 个元素)平均耗时: 8.1 毫秒

容量: 10000，执行次数: 1
PASS: 所有元素移除后，size 应为0
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 WAVLTree 中
添加 10000 个元素平均耗时: 348 毫秒
搜索 10000 个元素平均耗时: 147 毫秒
移除 10000 个元素平均耗时: 243 毫秒
buildFromArray(10000 个元素)平均耗时: 59 毫秒
changeCompareFunctionAndResort(10000 个元素)平均耗时: 79 毫秒
