...
**最后核对代码基线**：Web UI 语义音效语言（13 事件语义词典 + 面板 profile 分层 + 防双响）与 audioPrefs 跨 WebView 静音偏好同步（P0）source commit `b8565b3681e59dd977d71fb80b1493ffae8fac92`（tag `runtime-build-v2/20260816-web-ui-audio-semantics-v1`）、release tree `bf5bce5ea21863a72820eca20d02d46a0a6d5d38`、request `DFD21122D4AD20B351C9B47FC199A9B11AFE5F61E96EF98C8C557C619641C0F9` 已由本地 X509 `physical-host-b` 与 GitHub OIDC/Sigstore `github-hosted-windows`（cloud run `31921168151`）完成 v2 双 signer/双故障域 promotion；正式 runtime 绑定 identity `92D1CA0EC139CC9FD8D1144994792A47837FCC5FBCE1047D0DFCD9C92AA2124D`、closure `069F1A8A974CFE6F09898E89DD537943CCA5A3E522B719D30AA2DA5087D56F14`、Core SHA-256 `AB42F116426F975403BF16F96CED647A40F91B04ECC94FFA397DF891C2C98670`，promotion 提交 `88ac59b24d9c3014915cb100131d52c18950067c` 与 post-promotion audit run `31922327004`（`state=promoted`）均已推送/通过。音效语义权威契约见 [Web-UI音效-语义语言与接入契约-2026-08-15.md](docs/Web-UI音效-语义语言与接入契约-2026-08-15.md)；harness 只证明路由与语义归属，实际听感未人工验收。本列车没有 Audio emergency 或 H2 bypass：Audio H2 仍为专项 `pending`，只限制 Audio 的 `e2e_verified` / `standard_entry_verified` 声明；通用发布继续保留 immutable request、production policy、strict v2 verifier、atomic promotion 与 rollback。正式根入口 `--verify-only` 为 `exit 0`，但未执行面板业务专项正式旅程，故当前只称 `promoted`，不冒称 `standard_entry_verified`。此前 tooltip/合成链修复 `29ab59fd7832d10d54badc3132a5153646c1fa3d`、面板回包最小门 `704d836f42b70f788db8b5b2151c8ab3dcf77792`、Audio Platform v2 emergency `48c312234ab189b16f9edd2f5f7b0b2e78fc1407`、装备调制属性对比 `167d929a4bc3a85d6d21cc7faa220644eefe01d7`、跨层回包键 `a87be26f1d6e80c0ea8883bbc10e46c895c35799`、竞技场 P4/P5、商城旧档、双栏工作台、F8 与 F7 C1 均只保留为历史分层证据。
