...
namespace CF7Launcher.Tests.Tasks
{
    ...
    public class PetCatalogTests : IDisposable
    {
        ...
        private const string Fixture =
            ...
            "  </PetStore>\n" +
            "  <Pet><id>0</id><Name>P0</Name><Identifier>id0</Identifier><Height>100</Height>" +
            ...
            "  <Pet><id>1</id><Name>P1</Name><Identifier>id1</Identifier><Height>110</Height>" +
            ...
            "  <Pet><id>2</id><Name>P2</Name><Identifier>id2</Identifier><Height>120</Height>" +
            "<InitialLevel>1</InitialLevel><UnlockLevel>1</UnlockLevel><UnlockTask>0</UnlockTask><Unique>false</Unique>" +
        ...
        public void AdoptList_WebDirect_ReturnsCategoriesAndAdoptable_NoClientNeeded()
        {
            ...
            // categoryIndex 缺省 → 全部分类：CatA[0,1,2(+null skip)] + CatB[1] = 4 项
            var adoptable = (JArray)resp["adoptable"];
            Assert.Equal(4, adoptable.Count);
        ...
        public void AdoptList_WebDirect_FiltersByCategoryIndex()
        {
            ...
            Assert.Equal(2, ((JArray)resp["categories"]).Count);
            var adoptable = (JArray)resp["adoptable"];
