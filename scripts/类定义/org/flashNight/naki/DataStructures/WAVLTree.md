...
添加 100 个元素平均耗时: 2.15 毫秒
搜索 100 个元素平均耗时: 0.58 毫秒
移除 100 个元素平均耗时: 1.53 毫秒
buildFromArray(100 个元素)平均耗时: 0.57 毫秒
...
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 WAVLTree 中
添加 1000 个元素平均耗时: 30.7 毫秒
搜索 1000 个元素平均耗时: 8.4 毫秒
移除 1000 个元素平均耗时: 21.8 毫秒
...
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 WAVLTree 中
添加 10000 个元素平均耗时: 404 毫秒
搜索 10000 个元素平均耗时: 122 毫秒
移除 10000 个元素平均耗时: 300 毫秒
buildFromArray(10000 个元素)平均耗时: 48 毫秒
