...
测试规模: 10000 个元素
────────────────────────────────────────────────────────────────
  构建 TreeSet 耗时: 274 ms
  迭代器遍历: 101 ms (count=10000)
  toArray遍历: 13 ms (length=10000)
  后继搜索(3轮半遍历): 49 ms (avg)
...
测试规模: 50000 个元素
────────────────────────────────────────────────────────────────
  构建 TreeSet 耗时: 1645 ms
  迭代器遍历: 576 ms (count=50000)
  toArray遍历: 65 ms (length=50000)
  后继搜索(3轮半遍历): 276 ms (avg)
