...
正式 v2 consensus 当前绑定 tag `runtime-build-v2/20260822-player-asset-transactions-v2`、request `DD030AC6C7D780FBECC827D11828BD4959191AF182E46921CB480E3B08D4B8FD`、source commit `cf2fbd7b07fde5e008675fa1e6bda725bdfb96dd`、build identity `6CD9AEB99B3B5A3DF470F1CDDD99DF11CF7F706394F9FD3AF6D5594ABC03BC78` 与 payload closure `60EA3AACDBFAAE178866317448FCEA0BEC0D3AA73E808AD4952ACF695571F62D`。local signer 位于 `physical-host-b`，不可导出 keyId 为 `EB5D32E04B6EE8697850314E19698DE1A3FACFFCCC6418A12CF7FEDE6033CDA5`；GitHub Actions run `32548053397` 的 OIDC identity `55A499A0AF91FFB53BC95E0BC168A288705E675AC3F2469EF1453FFEBF0193BB` 提供 `github-hosted-windows` 第二票。production policy `4B98DD6B14E31D038BE7B25C07F79355FA473FCD342823D616EA3212F1347819` 的 38/38 final receipt SHA-256 为 `4A5FC71CE10EBBBE4BDD487F34A0EA3A7FC9D1939E815544CE50F15A719E5546`；promotion commit `b7f075e53c31c5d4b67e02dcda1978695321d33d` 已由 post-promotion audit run `32548688437` 确认为 `state=promoted`、`deploymentChanged=true`，严格 manifest/consensus 校验为 33 files、2 signers、2 faultDomains。维护者已接受与正式 Core 逐字节相同的隔离候选；部署后未重跑无 candidate id 的正式业务入口，因此本列车只称 `HUMAN_ACCEPTANCE_PASSED / promoted`，不称 `standard_entry_verified`。cloud workflow 仍只允许 `Crazyfs` / `Flash-Night` 的固定 actor ID 首次 dispatch。
