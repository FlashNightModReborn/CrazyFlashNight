...
function audit(){
  ...
  if(!inOrder(registryWorkbench,["'modules/item-filter.js'","'modules/asset-timeline.js'","'modules/dressup-doll-renderer.js'","'modules/workbench-inspection-viewport.js'","'modules/equipment-inspector.js'","'modules/inventory-runtime.js'","'modules/inventory-ui.js'","'modules/equipment-tuning-runtime.js'","'modules/equipment-tuning-model.js'","'modules/equipment-tuning-render.js'","'modules/equipment-tuning-view.js'","'modules/inventory-workbench-config.js'","'modules/inventory-workbench-header.js'","'modules/inventory-workbench-quick-transfer.js'","'modules/inventory-workbench-owned-view.js'","'modules/inventory-tuning-scope.js'","'modules/inventory-storage-workbench.js'","'modules/character-build-session.js'","'modules/character-build/character-build-stats-view.js'","'modules/character-build/character-build-doll-preview.js'","'modules/character-build-view.js'","'modules/character-build/character-build-tuning.js'","'modules/character-build.js'","'modules/inventory-workbench.js'"])
