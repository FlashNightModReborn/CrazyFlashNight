...
**2026-08-15 Audio 发布列车当前态**：source `48c312234ab189b16f9edd2f5f7b0b2e78fc1407` / tree `effd7c33f4623dd2dbae596d58cc9b8a08b6a072` 已通过 owner-emergency 明示旁路、双 signer / 双 faultDomain、production policy、strict v2 verifier 与原子 promotion 进入正式 runtime；request 为 `00D6B5445138406C643BF62FD1270BB9F15938D4D8B37F6D1F5360FC6BEC9405`，identity 为 `50538C0BA1516E1BA09AE86BB94B2C885A02C106C5EB6FBAA806C47AFFB5CB4A`，closure 为 `FE874BA9CAC43B4ED944A1B5606DFDD03176C02A89F510338CEC251B2C768793`。正式入口只完成同身份启动、优雅退出与零残留 smoke；Audio E1/H2/E3 被明确 bypass，H2 未满足且未伪造，完整 Audio 专项纵切未完成，因此 `standard_entry_verified=false`。
...
**最后核对代码基线**：current formal release source commit `48c312234ab189b16f9edd2f5f7b0b2e78fc1407`、release tree `effd7c33f4623dd2dbae596d58cc9b8a08b6a072`、request `00D6B5445138406C643BF62FD1270BB9F15938D4D8B37F6D1F5360FC6BEC9405`（2026-08-15）；本地 X509 `physical-host-b` 与 GitHub OIDC/Sigstore `github-hosted-windows` 已完成双 signer / 双 faultDomain v2 promotion，正式 runtime 绑定 identity `50538C0BA1516E1BA09AE86BB94B2C885A02C106C5EB6FBAA806C47AFFB5CB4A`、closure `FE874BA9CAC43B4ED944A1B5606DFDD03176C02A89F510338CEC251B2C768793`。该列车由 owner emergency 明示 bypass Audio E1/H2/E3；正式入口只验证同身份启动、优雅退出与零残留，严格为 `promoted / standard_entry_verified=false`，不冒称 H2 或 Audio 专项纵切。此前跨层回包、P4/P5、F8 与 A1–A6 release 均只保留为历史分层。
