...
当前 consensus 精确绑定 request `DFD21122D4AD20B351C9B47FC199A9B11AFE5F61E96EF98C8C557C619641C0F9` 与 release tree `bf5bce5ea21863a72820eca20d02d46a0a6d5d38`。artifact source 为 `1D9F9ED0270440B13BD69BD48AFA7D4868B742369D58E127C78207134004D78A`、producer recipe `93A007D1BD03C54F3CC257F1E4610354BBBB83C97B635AC28C2B5D393C75868A`、toolchain lock `7B83229BE93F8244810CDD23DAFD97875B23857E547DE520035FE23B453CB3CD`、policy `520E4A2079A44B54884CE3AA7CC182FB1A1C17D91310EE85C2A68B19D9650AE6`；build identity `92D1CA0EC139CC9FD8D1144994792A47837FCC5FBCE1047D0DFCD9C92AA2124D`、payload closure `069F1A8A974CFE6F09898E89DD537943CCA5A3E522B719D30AA2DA5087D56F14`、manifest SHA-256 `984A23CC0661BF2F2573B532565825ACA963FA0566D9416B120E57CE3AC0169D`、promotion 后 Windows worktree consensus bytes SHA-256 `A599EB3530C9EC122851C3784FDA16854BC0E73AE7DBAA5EF60FB7E6867178E7`。production policy receipt SHA-256 为 `8D1C1E988006D34D49F5D8C380E1209418DE03D8859532D9EC8EE82BF2419C5F`；本地 X509 signer `EB5D32E04B6EE8697850314E19698DE1A3FACFFCCC6418A12CF7FEDE6033CDA5` / `physical-host-b` 与 GitHub OIDC builder `616496639BE84CEF2CDFABD75D0F7E2D2CC0E68012AFEF776103196208C445DD` / `github-hosted-windows`（run `31921168151`）满足双 signer、双 faultDomain、production receipt 与 v2 strict/full-install verifier，于 `2026-08-16T02:31:11Z` 完成 promotion。

当前正式部署的根 EXE SHA-256 为 `55EABB5C3280FDFEE8302843D969C6B6354808F1AF4DC24DB5E2397AA80499D8`（未变），Core DLL SHA-256 为 `AB42F116426F975403BF16F96CED647A40F91B04ECC94FFA397DF891C2C98670`，`miniaudio.dll` SHA-256 为 `AC3A8FC3BE306D595918F392B44E298D95B71221311920E892C4BE2A6E3AD20A`（未变）。部署后 33-file bundle、signed consensus 与正式根入口 `--verify-only` 分别通过；post-promotion audit run `31922327004` 精确报告 base `b8565b3681…`、head `88ac59b24d…`、`state=promoted`。本轮未完成面板或 Audio 专项正式旅程，Web UI 音效的实际响度/音色/疲劳度亦未经人工听感验收，因此不声称对应 `standard_entry_verified`，也不外推任何业务写或玩家目视签收。下行仍以“当前”描述旧 source / identity 的段落均按历史列车输入阅读，不覆盖本段。
