...
当前材料的档次区分成 低级材料  中等材料  高等材料  特殊材料，不在低中高范围内的均可归纳到特殊材料中，材料的设定文案以 data\items\收集品_材料.xml  为准

当前材料的用途可以分成 通用   防具专用  枪械专用 刀专用 拳专用(规划中但尚未落实)
