...
_root.宠物升级加载 = function(i)
{
	...
	if (当前宠物信息[4] == 1 && 当前宠物信息[2] >= 0)
	{
		...
		var 新宠物对象 = _root.gameworld.attachMovie(宠物标识符,宠物僵尸型敌人newname,_root.gameworld.getNextHighestDepth(),{等级:宠物等级, 名字:宠物名字, 宠物属性:this.宠物属性, 是否为敌人:宠物是否为敌人, 身高:宠物身高, _x:temppet_x, _y:temppet_y,称号:称号});
		_root.宠物mc库[i] = 新宠物对象;
	}
}
