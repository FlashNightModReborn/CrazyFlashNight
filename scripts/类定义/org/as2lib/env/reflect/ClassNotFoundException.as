...
/**
 * {@code ClassNotFoundException} is thrown to indicate that the class that has
 * been searched for could not be found.
 * 
 * @author Simon Wacker
 */
class org.as2lib.env.reflect.ClassNotFoundException extends ReflectionException {
	
	/**
	 * Constructs a new {@code ClassNotFoundException} instance.
	 *
	 ...
	 */
	public function ClassNotFoundException(message:String, thrower, args:Array) {
