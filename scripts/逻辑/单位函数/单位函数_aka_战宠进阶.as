...
_root.战宠进阶函数.能量子弹 = {
	...
	背景:"武术",
	详情页描述:function(){
		var 基础介绍 = "掌握净化能力。<br>提升自身攻击力，并解锁"+this.进阶方案.能量子弹.名称+"，在敌方目标的物理防御能力强于能力抗性时，使用能量子弹，造成能量伤害。射击时可斩杀10%生命值以下的敌人，并有30%的概率造成1.5倍暴击。"
		if(this.当前宠物信息[1] < this.进阶方案.能量子弹.解锁等级){
...
_root.战宠进阶函数.剧毒子弹 = {
	...
	背景:"武术",
	详情页描述:function(){
		var 基础介绍 = "掌握净化能力。<br>提升自身攻击力、防御力与hp，并解锁"+this.进阶方案.剧毒子弹.名称+"，在敌方目标的物理防御与能量抗性较高时，使用剧毒子弹，额外造成剧毒伤害。射击时可斩杀20%生命值以下的敌人，并有50%的概率造成2倍暴击。"
		if(this.当前宠物信息[1] < this.进阶方案.剧毒子弹.解锁等级){
