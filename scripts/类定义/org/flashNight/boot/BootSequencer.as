...
class org.flashNight.boot.BootSequencer {
    ...
    function step():Void {
        switch (this.state) {
            ...
            case S_SYNCLOGIC: this.b.s7_syncLogic(); this.host.打印加载内容("加载杂项数据……"); this.b.s7_miscLoaders(); org.flashNight.arki.interaction.NativeMenuBridge.install(); org.flashNight.arki.dialogue.NativeDialogueService.install(); this.state = S_FANOUT; break;
