...
**最后核对代码基线**：loot feed 物品获得与击杀播报（左下 NativeHud 图标卡片流：五途径物品获得、enemyKilled 事件链击杀播报、运行时纸娃娃头像异步烘焙与占位卡原地升级）release source commit `3053a405670bd76db2f5c234baa310aefe88c100`（bindings `67119fb8103e9ad96aea430af3187fc78e4cf937`，tag `runtime-build-v2/20260818-loot-feed-v2`）、release tree `5e98716245f5bcf4f12b17e3c9c501b0226fc944`、request `1E0C27E96F71B4F78F225AE837945C1FB4D21B7A65B7C6B6FAB4C395AB08E0C3` 已由本地 X509 `builder-local-a` / `physical-host-a` 与 GitHub OIDC/Sigstore `github-hosted-windows`（cloud run `32127122076`）完成 v2 双 signer/双故障域 promotion；正式 runtime 绑定 identity `89E7E00CC6183C30A28CBF4A662F8650AA8908AFCC2E8202FD203E3F16A1E384`、closure `EE7835968A403B3EFC87E1CECDC52DA6965A59B08C2D09903C7488EBC6711E3D`、Core SHA-256 `EDB79B8A59D4B35C4AB243AF81B17B5C9B6E8CDDAAA7BCE157CA86CC37203161`，production receipt SHA-256 `698E305D438DFCF01BBFE3ECC689B39A0DA33055DE000D45715AE5CF74A5F738`（33/33），promotion 提交 `f16af5dc2d44bc2391394c644375be772d19c30f` 与 post-promotion audit run `32130065217` 均已推送/通过，审计明确输出 `state=promoted`、`deploymentChanged=true`。领域工程证据为 Launcher 全量 3858 pass + 3 explicit opt-in skip / 3861 total、Loot/Doll 域 239 项、web doll-bake harness 8/8、fresh AS2 publish-only compiler 0/0、doc governance 通过；部署后 bundle、consensus 与根 bootstrap `--verify-only` 均通过。维护者在发布前完成多轮隔离候选人工旅程（拾取/任务/箱子/击杀/动效/全屏），未在 promotion 后重跑正式业务旅程，故本列车只称 `promoted`，不称 `standard_entry_verified`。本列车前两个 request（`2D74BBE0…` config 指旧 tag、`9DF96067…` tag 不自指）均未 dispatch 云构建、未 promotion，按协议原子 supersede；`runtime-build-v2/20260818-loot-feed-v1` 为未使用历史冻结 tag。此前合成工作台 P1–P4 release source commit `fbd096f1a481580f60c9904eb162fb31416752a7`（tag `runtime-build-v2/20260817-crafting-procurement-workbench-v2`）、release tree `53a609832c293ab1539e5123d6216fa971d342a2`、request `E74B2E153AF64027EAAAF9D08DAFDE5379105BD3391BF733814B701F0CE0C290` 已由本地 X509 `physical-host-a` 与 GitHub OIDC/Sigstore `github-hosted-windows`（cloud run `32036301461`）完成 v2 双 signer/双故障域 promotion；正式 runtime 绑定 identity `41D05C08C6B37A3197545B1414A0098E9E60F262B61965C6CFDAE32E4F9B3A58`、closure `24B18E53A922293F3EDBA29997A7F722EA5E7E0417EF395FE9591C728D488D1F`、Core SHA-256 `907771B22A6A318741BBF690D338BF7AF9EBABB3BE91C5A0334C58439F21AD02`，promotion 提交 `1242711521aef2ed1024a9527d8d9a83e9d63c4f` 与 post-promotion audit run `32038829319` 均已推送/通过，审计明确输出 `state=promoted`、`deploymentChanged=true`。领域工程证据为 282/282 配方身份、Panel contract 4 domains / 23 commands 与 66/66 变异、Crafting runtime 36/36、Panel runtime 41/41、Crafting 三视口各 `150+15+8+10+6+9+26+12+9+17`、NPCShop `130/130 + 23/23 + 2/2`、KShop 151/151、Launcher 3770 pass + 3 explicit opt-in skip / 3773 total、fresh AS2 Crafting 151/151 + Synthesis 18/18 与 publish-only compiler 0/0；production policy 35/35，部署后 bundle、consensus 与根 bootstrap `--verify-only` 均通过。维护者在发布前已通过 P4 短人工旅程；未在 promotion 后重跑正式业务旅程，故本列车只称 `promoted`，不称 `standard_entry_verified`。首个 request `EA5DE50C41E55EA2D633A7B63BC9D2E92FEE30E55DD0C5C3B346A3AAC7A3F012` 在本地策略门暴露材料字典绑定与头像 provenance 陈旧后停止，未 dispatch 云构建、未 promotion，随后由当前 request 原子 supersede。此前角色构筑堆叠/调制修复 `60d672332d31bf7b33f75a9b42a4ac6454fb9ca8`、选关界面工作台 `f0c501fcdf74220a5cb6388f01692db7c96389d2`、NPC 商店 snapshot 数量污染防护 `9df1fb8fdadf1df10c6bcc9b0552ebcfcf16a834`、Web UI 音效语义/audioPrefs `b8565b3681e59dd977d71fb80b1493ffae8fac92`、tooltip/合成链修复 `29ab59fd7832d10d54badc3132a5153646c1fa3d`、面板回包最小门 `704d836f42b70f788db8b5b2151c8ab3dcf77792`、Audio Platform v2 emergency `48c312234ab189b16f9edd2f5f7b0b2e78fc1407`、装备调制属性对比 `167d929a4bc3a85d6d21cc7faa220644eefe01d7`、跨层回包键 `a87be26f1d6e80c0ea8883bbc10e46c895c35799`、竞技场 P4/P5、商城旧档、双栏工作台、F8 与 F7 C1 均只保留为历史分层证据；Audio H2 继续作为专项 `pending`，不进入通用 runtime promotion 门。
...
## Context Packs（按任务最小加载，最后核对 commit `3053a405670bd76db2f5c234baa310aefe88c100`）
