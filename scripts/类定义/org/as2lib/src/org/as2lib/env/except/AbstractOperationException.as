...
/**
 * {@code UnsupportedOperationException} is thrown to indicate that an operation
 * marked by the developer as abstract has not been overwritten.
 *
 * @author Simon Wacker
 */
class org.as2lib.env.except.AbstractOperationException extends FatalException {
	 ...
	 */
	public function AbstractOperationException(message:String, thrower, args:Array) {
