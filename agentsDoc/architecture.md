...
**最后核对代码基线**：CF7 Agent Runtime / Wings F8 正式发布 source commit `6f3d50a52413c747b05b74be88d6ee46650f4597`、tree `253e57f6d20a90fef6addfa744d0487d88f00dfb`（2026-07-31）已由 immutable tag `runtime-build-v2/20260731-agent-runtime-wings-f8-v1`、request `A9B33601805709DBB5EAE6DAF312C2B7B0B502096FDD3BDCEA9CBE26D8B1299C` 与本地 X509 + GitHub OIDC/Sigstore 双故障域共识完成 v2 promotion；正式 runtime 绑定 identity `0F4C92F237ABD7785C957F3CD135ABF2EFB1EB5D9AB5671B869F39D00970675C`、closure `54FBCCBA7C90ACF407B09E38FFB874C13DE3CDFB80CF62D0F8D4E239A42962F0` 与 Core EXE `86DF1F5DC611037DB3A85FD9BA0D43490394F232D25A4F62B59AA4F2B4B6E4FD`。无 candidate id 的正式入口 pure-MCP run `20260731T040942Z` 达到 `standard_entry_verified`，但只验证单屏 Launcher/NativeHud/WebOverlay WGC、Flash metadata-only fail-closed、structured `panel.open` 帮助面板与 supported shutdown；不外推为物理双屏、“13/13”、Flash pixels/input、Hair、Wings 完整产品、业务写或持久化验收。此前 `f01f4b121a4c…` no-AS2-fallback release 及其 Equipment Tuning 标准入口证据保留为历史。
