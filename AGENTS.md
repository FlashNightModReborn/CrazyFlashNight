...
**最后核对代码基线**：选关界面双栏工作台基础体系对齐（P0–P4：golden inventory 计数真值闭环、PanelScale/生命周期/token 化与 CSS 拆分、键盘路径与 pinned 决策检查器、instance/session 协议加固、控制器四层拆分与 hover 预览派生管线）、逐关锁定原因 snapshot 扩展（AS2 `lockReason`）与两轮实机品质打磨 source commit `f0c501fcdf74220a5cb6388f01692db7c96389d2`（tag `runtime-build-v2/20260816-stage-select-workbench-v1`）、release tree `34c94d9136d897f83e942106151b6d4c5862ae3a`、request `DB58FE228CCEA955FC81BE2625676262BEBDE8AFD74108FE4939436AD3FAFA39` 已由本地 X509 `physical-host-a` 与 GitHub OIDC/Sigstore `github-hosted-windows`（cloud run `31945976799`）完成 v2 双 signer/双故障域 promotion；正式 runtime 绑定 identity `915B3E22FCA273BA95FE850D5F13D9BB1CF708B920A4FE5BAFB02E2A45816B66`、closure `CF593FF86173506C791DAEBE2C8B9A1FA46CC68CB7E1E1C5AFDB8893B1FAD05C`、Core SHA-256 `A4ADD6A4A2EC6138F87D25945EE3727C2D9036C0CFB25831C61E251FAC053CA3`，promotion 提交 `a1798e4edf94be7168f01cc4f1490f2c1fb6fed5` 与 post-promotion audit run `31947003064` 均已推送/通过。领域工程证据为 mock-browser harness 53/53、focused xUnit 142/142 与 Flash CS6 publish-only smoke（compiler 0/0 + SWF 刷新 + FFDec 标志串核实）；正式入口身份核验通过，且测试员在正式运行时内完成选关面板实机 smoke（选中金环/检查器/逐关锁定原因/键盘难度导航/Esc 分层），达到 `standard_entry_verified`。此前 NPC 商店 snapshot 数量污染防护 `9df1fb8fdadf1df10c6bcc9b0552ebcfcf16a834`、Web UI 音效语义/audioPrefs `b8565b3681e59dd977d71fb80b1493ffae8fac92`、tooltip/合成链修复 `29ab59fd7832d10d54badc3132a5153646c1fa3d`、面板回包最小门 `704d836f42b70f788db8b5b2151c8ab3dcf77792`、Audio Platform v2 emergency `48c312234ab189b16f9edd2f5f7b0b2e78fc1407`、装备调制属性对比 `167d929a4bc3a85d6d21cc7faa220644eefe01d7`、跨层回包键 `a87be26f1d6e80c0ea8883bbc10e46c895c35799`、竞技场 P4/P5、商城旧档、双栏工作台、F8 与 F7 C1 均只保留为历史分层证据；Audio H2 继续作为专项 `pending`，不进入通用 runtime promotion 门。
