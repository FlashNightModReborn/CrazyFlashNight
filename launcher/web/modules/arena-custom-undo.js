(function(root, factory) {
    ...
    function snapshot(editor, options) {
        ...
        return {
            ...
            spawnDistance: editor.spawnDistance || options.defaultSpawnDistance || 650,
            blueFormation: editor.blueFormation || options.defaultFormation || 'line',
            redFormation: editor.redFormation || options.defaultFormation || 'line',
            formationSpacing: editor.formationSpacing || options.defaultFormationSpacing || 54,
