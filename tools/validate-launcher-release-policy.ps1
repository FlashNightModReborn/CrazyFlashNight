...
function Get-Cf7ProductionChecks {
    ...
    $requiredWebPaths = @(
        ...
        'css\task_panel.css', 'css\pet_panel.css', 'css\merc_panel.css', 'css\team_panel.css',
        ...
        'modules\crafting.js', 'modules\skills-runtime.js', 'modules\skills-library.js',
        ...
        'modules\map-hud.js', 'modules\stage-select-data.js', 'modules\stage-select-panel.js',
        'modules\pet-panel.js', 'modules\merc-data.js', 'modules\merc-panel.js',
        'modules\team\team-panel.js', 'modules\arena-meta-rosters.js', 'modules\arena-factions.js',
