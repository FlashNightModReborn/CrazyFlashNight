...
_root.战宠进阶函数.涅槃重生 = {
	...
	描述:function(){
		if(this.当前宠物信息[1] < this.进阶方案.涅槃重生.解锁等级){
			return this.进阶方案.涅槃重生.解锁等级 + "级以上可以进阶，提高攻击、韧性，获得涅槃之力"
		}
		if(this.当前宠物属性.涅槃重生){
			return "已进阶"
		}
		return "点击可进阶，提高攻击、韧性，并获得涅槃之力,需要消耗"+ this.进阶方案.涅槃重生.消耗金币+"金币";
	},
	详情页:true,
	执行按钮文字:"进阶能力",
	背景:"默认",
	详情页描述:function(){
		var 基础介绍 = "于火中升华，完全掌握烈焰与重生之力。<br>提升攻击力、韧性，融合一二阶段并各取所长，可以立刻造成热属性伤害并持续回复生命。"
		if(this.当前宠物信息[1] < this.进阶方案.涅槃重生.解锁等级){
