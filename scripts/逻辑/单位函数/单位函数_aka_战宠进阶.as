...
_root.战宠进阶函数.剧毒子弹 = {
	...
	描述:function(){
		...
		return "点击可解锁"+this.进阶方案.剧毒子弹.名称+"，在敌方目标的物理防御与能量抗性较高时，使用剧毒子弹，额外造成剧毒伤害。射击时可斩杀20%生命值以下的敌人，并有50%的概率造成2倍暴击。同时将提高“黑”的攻击力、防御力与hp。需要消耗"+ this.进阶方案.剧毒子弹.消耗金币+"金币";
	},
	详情页:true,
	执行按钮文字:"解锁子弹",
	背景:"装备",
	详情页描述:function(){
		var 基础介绍 = "装配剧毒子弹并进行训练。<br>提升自身攻击力、防御力与hp，并解锁"+this.进阶方案.剧毒子弹.名称+"，在敌方目标的物理防御与能量抗性较高时，使用剧毒子弹，额外造成剧毒伤害。射击时可斩杀20%生命值以下的敌人，并有50%的概率造成2倍暴击。"
		if(this.当前宠物信息[1] < this.进阶方案.剧毒子弹.解锁等级){
