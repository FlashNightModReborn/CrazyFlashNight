...
添加 100 个元素平均耗时: 1.14 毫秒
搜索 100 个元素平均耗时: 1.07 毫秒
移除 100 个元素平均耗时: 1.12 毫秒
buildFromArray(100 个元素)平均耗时: 1.25 毫秒
changeCompareFunctionAndResort(100 个元素)平均耗时: 1.3 毫秒

容量: 1000，执行次数: 10
PASS: 所有元素移除后，size 应为0
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 ZipTree 中
添加 1000 个元素平均耗时: 13.5 毫秒
搜索 1000 个元素平均耗时: 18 毫秒
移除 1000 个元素平均耗时: 18.3 毫秒
buildFromArray(1000 个元素)平均耗时: 14.4 毫秒
changeCompareFunctionAndResort(1000 个元素)平均耗时: 15.5 毫秒

容量: 10000，执行次数: 1
PASS: 所有元素移除后，size 应为0
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 ZipTree 中
添加 10000 个元素平均耗时: 158 毫秒
搜索 10000 个元素平均耗时: 215 毫秒
移除 10000 个元素平均耗时: 199 毫秒
buildFromArray(10000 个元素)平均耗时: 156 毫秒
changeCompareFunctionAndResort(10000 个元素)平均耗时: 163 毫秒
