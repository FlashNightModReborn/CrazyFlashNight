...
$focusedRun = @{
    ...
    ExpectedTracePatterns = @('(?m)^TitaniumSetRuntimeTest Tests Passed: 211\r?$', '(?m)^TitaniumSetRuntimeTest Tests Failed: 0\r?$')
    SuccessSummary = '钛合金反馈回归211/211：起跳保护、砸地配给、取消归属、复活与171副射'
