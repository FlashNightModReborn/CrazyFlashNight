...
export const DEMO_2_HELP_PROFILE = {
    ...HELP_PROFILE,
...
export function helpProfileForScenario(scenarioId) {
...
export function openHelpUi(state, anchor = 'overview') {
    return { ...state, open: true, anchor };
}
export function closeHelpUi(state) {
    return { ...state, open: false };
}
export function isHelpAnchor(value) {
    return [...HELP_PROFILE.sections, ...DEMO_2_HELP_PROFILE.sections]
        .some((section) => section.anchor === value);
}
//# sourceMappingURL=help-profile.js.map