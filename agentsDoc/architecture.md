...
**最后核对代码基线**：commit `5b624757113c302ec756b0a8a6a809a2a8d862a5`（2026-07-23）；高变动功能、构建与验收状态仍以对应专题 canonical doc 为准。
