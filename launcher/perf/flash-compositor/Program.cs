...
internal sealed class ProbeForm : Form
{
    ...
    internal ProbeForm(Options options)
    {
        ...
        {
            "toproot" => ["raw", "night", "nightvision", "p-marker", "occluded", "offscreen", "restored", "minimized", "restore-minimized", "hidden", "restore-hidden", "resized", "viewport-held", "viewport-resumed"],
            "embeddedF" => ["raw", "night", "nightvision", "p-marker", "covered", "occluded", "offscreen", "restored", "minimized", "restore-minimized", "hidden", "restore-hidden", "resized", "viewport-held", "viewport-resumed"],
            _ => ["raw", "night", "nightvision", "occluded", "offscreen", "restored", "minimized", "restore-minimized", "hidden", "restore-hidden", "resized", "viewport-held", "viewport-resumed"]
        };
    ...
    private bool CorePassed() => failure == null && phases.Count == plan.Length
        ...
        && latest.CpuReadbacks == latest.ProofCount*6 + contentStats.Count*2
