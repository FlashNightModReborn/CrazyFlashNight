...
测试规模: 10000 个元素
────────────────────────────────────────────────────────────────
  构建 TreeSet 耗时: 359 ms
  迭代器遍历: 105 ms (count=10000)
  toArray遍历: 13 ms (length=10000)
  后继搜索(3轮半遍历): 51 ms (avg)
...
测试规模: 50000 个元素
────────────────────────────────────────────────────────────────
  构建 TreeSet 耗时: 2111 ms
  迭代器遍历: 587 ms (count=50000)
  toArray遍历: 71 ms (length=50000)
  后继搜索(3轮半遍历): 280 ms (avg)
