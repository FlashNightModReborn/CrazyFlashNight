...
不要在这里添加字体、role、下载地址或手工修改 manifest。普通维护流程见 [`fonts/README.md`](../../../../fonts/README.md)；运行时通过 exact-set `cfn-fonts.local` handler 按 `temporary/custom → temporary/cache → permanent/runtime` 提供 XML 已声明的文件。
