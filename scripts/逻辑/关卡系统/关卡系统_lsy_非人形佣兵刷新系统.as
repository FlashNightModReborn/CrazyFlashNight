...
_root.添加门口可雇用敌人 = function(X, Y){
	var 佣兵数据 = LinearCongruentialEngine.getInstance().getWeightedRandomElement(_root.可雇佣敌人列表, _root.可雇佣敌人权重表);
...
_root.可雇佣敌人列表 = new Array(15);
_root.可雇佣敌人权重表 = new Array(15);
...
_root.可雇佣敌人权重表[6] = 6;
_root.可雇佣敌人列表[7] = {兵种:"敌人-黑铁会刺客", 名字:"黑铁刺客", 身高:175, 性别:"男", 身份:"黑铁会部众", 战宠编号:10};
_root.可雇佣敌人权重表[7] = 5;
_root.可雇佣敌人列表[8] = {兵种:"敌人-黑铁会大叔", 名字:"黑铁大叔", 身高:185, 性别:"男", 身份:"黑铁会部众", 战宠编号:11};
_root.可雇佣敌人权重表[8] = 5;
_root.可雇佣敌人列表[9] = {兵种:"敌人-劫掠少女", 名字:"掠夺少女", 身高:176, 性别:"女", 身份:"狂野玫瑰成员", 战宠编号:95};
_root.可雇佣敌人权重表[9] = 4;

_root.可雇佣敌人列表[10] = {兵种:"敌人-精英战术少女", 名字:"精英战术少女", 身高:165, 性别:"女", 身份:"狂野玫瑰成员", 战宠编号:71};
_root.可雇佣敌人权重表[10] = 3;
_root.可雇佣敌人列表[11] = {兵种:"敌人-双喷少女", 名字:"摇滚学姐", 身高:175, 性别:"女", 身份:"狂野玫瑰成员", 战宠编号:72};
_root.可雇佣敌人权重表[11] = 2;
_root.可雇佣敌人列表[12] = {兵种:"敌人-刀狙少女", 名字:"精锐掠夺少女", 身高:180, 性别:"女", 身份:"狂野玫瑰成员", 战宠编号:96};
_root.可雇佣敌人权重表[12] = 2;
_root.可雇佣敌人列表[13] = {兵种:"敌人-黑铁死士精英", 名字:"黑铁游侠", 身高:175, 性别:"男", 身份:"黑铁会部众", 战宠编号:86};
_root.可雇佣敌人权重表[13] = 2;
_root.可雇佣敌人列表[14] = {兵种:"敌人-黑铁精英流锤兵", 名字:"黑铁流锤", 身高:175, 性别:"男", 身份:"黑铁会部众", 战宠编号:87};
_root.可雇佣敌人权重表[14] = 2;
_root.可雇佣敌人列表[15] = {兵种:"敌人-黑铁重锤", 名字:"黑铁重锤", 身高:190, 性别:"男", 身份:"黑铁会部众", 战宠编号:76};
_root.可雇佣敌人权重表[15] = 1;
_root.可雇佣敌人列表[16] = {兵种:"敌人-黑铁武士", 名字:"黑铁武士", 身高:175, 性别:"男", 身份:"黑铁会部众", 战宠编号:88};
_root.可雇佣敌人权重表[16] = 1;
