...
│   │   │   ├── PlayerInfo/                 HP/MP canonical SVG、typed manifest、strict facade、physical raster planner、PArgb rasterizer 与 16 MiB atomic-batch pipeline（B0；尚无 widget/真实 UiData）
...
当前基地理发店 Web-only consensus 采用 `builder-local-a`（keyId `28DBEAF3761CCF3177FE396596A2557D8A6C9393371CD41DC893FF75A02723B3`）/ `physical-host-a` 与 GitHub OIDC builder identity `1E1DC9F870607E5E11583275C0CD877B76181D97E70DDEB0EF84D59CDDB7A669` / `github-hosted-windows`（run `30073314631`）；tracked registry 仍只含公钥。正式 bootstrap/runtime/manifest/consensus 已由唯一 promotion 入口切换到 request `DC44D51855EFDE2D7F3223CA3038008023B36A404BB32064511C962ABF824131`、build identity `3F6110809903BF28D08E90F92087A4333E5C604F0AC62994E945775690CD25C6` 与 payload closure `C16ED23C85DCF0C2B2A321158F2269BED9D45ACC32BACCD428ED51AD4D49E107`；地图资源箱、商店与单-canary consensus 均只保留为历史记录。一次性 migration fuse 不得复用，后续发布不得降级 v1。
