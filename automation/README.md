...
正式 v2 consensus 当前绑定 tag `runtime-build-v2/20260823-audit-hardening-rollup-v1`、request `27EC76E92B7DC15E3BC5D1A97AFBF630CB45956083B324A70D0AFBBA4BBA8D5D`、source commit `0b7d5ec1880bfdbbcf252070d219c47af1811dac`、release tree `6ca54c80bec36b8614290990a56848a26f3c5842`。
build identity 为 `D19105140D0EC8AB0C70E227BF072711BD471377B26FF49E5802D18979DFD985`，payload closure 为 `8843DA037AE24362D539788B7CA9FBF8ABAF5B52C257909B9AE052D3EBC941CA`。local signer 位于 `physical-host-b`，不可导出 keyId 为 `EB5D32E04B6EE8697850314E19698DE1A3FACFFCCC6418A12CF7FEDE6033CDA5`；GitHub Actions run `32613026008` 的 OIDC identity `2D97B5C9BC4F7AD21709B803CF7E24334185A51924C742EFD11F6A88C67412C7` 提供 `github-hosted-windows` 第二票。
production policy `E41E6173F2936EB63A13D863110CCC7B77D7D7834755C46B2CA663C00CB92A8B` 的 38/38 final receipt SHA-256 为 `DB835449F10AAC65ED4C030E2B00A2C9641405FB0B6C02DDF87A4CAAB1ED6C89`；promotion commit `19f57d0fe6383f0ec9cae4d73646cf8197bd6ee5` 已由首次 post-promotion audit run `32613483455` 确认为 `state=promoted`、`deploymentChanged=true`，严格 manifest/consensus 为 33 files、2 signers、2 faultDomains。
无 candidate selector 的正式入口还取得 fresh reveal、前后两次 `session.status=verified`、同 lifecycle、strict shutdown receipt、Flash/Guardian exit 0 与零进程残留。该 smoke 只证明正式身份和生命周期，不代签本列车各业务专项 `standard_entry_verified`。cloud workflow 仍只允许 `Crazyfs` / `Flash-Night` 的固定 actor ID 首次 dispatch。
