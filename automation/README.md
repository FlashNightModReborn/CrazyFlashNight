...
**文档角色**：启动与运行自动化入口。  
**最后核对代码基线**：当前基地理发店 Web-only 发布冻结 source commit `7237762fa9b5b89b5cb103c3d73e67ef46b08756`（tag `runtime-build-v2/20260724-p0f-hairdresser-web-only-v1`、request `DC44D51855EFDE2D7F3223CA3038008023B36A404BB32064511C962ABF824131`），由 commit `5c074eb4192d05df6fa58dc940301877a89a1d65` 记录正式 promotion；无参标准入口首次 bootstrap attempt `0ebb4f1d1bd94585add33f20538e8ee1` 与重启 bootstrap attempt `fac214115f3743308234c0e995193aca` 已验证正式 manifest 并以 `formal_runtime` 启动，维护者完成“蓝色头巾”提交、自动关闭、存盘、完整退出及重启回读，严格状态为 `standard_entry_verified`。
...
正式 v2 consensus 当前绑定 tag `runtime-build-v2/20260724-p0f-hairdresser-web-only-v1`、request `DC44D51855EFDE2D7F3223CA3038008023B36A404BB32064511C962ABF824131`、source commit `7237762fa9b5b89b5cb103c3d73e67ef46b08756`、build identity `3F6110809903BF28D08E90F92087A4333E5C604F0AC62994E945775690CD25C6` 与 payload closure `C16ED23C85DCF0C2B2A321158F2269BED9D45ACC32BACCD428ED51AD4D49E107`；promotion 记录 commit 为 `5c074eb4192d05df6fa58dc940301877a89a1d65`。本次 local signer 是 `builder-local-a` / `physical-host-a`，不可导出 keyId 为 `28DBEAF3761CCF3177FE396596A2557D8A6C9393371CD41DC893FF75A02723B3`、thumbprint 为 `647AFE92BD801518AF25F2A2EE1845E6847C2118`；GitHub Actions run `30073314631` 的 OIDC identity `1E1DC9F870607E5E11583275C0CD877B76181D97E70DDEB0EF84D59CDDB7A669` 提供 `github-hosted-windows` 第二票。production policy `BA495554E0F136BE714464D5036F180C2BB25C607E09B50B9308A328BDE4801D` 的 21/21 final receipt SHA-256 为 `2991C42B9D59831802E2CC07287B91CE6B1FC81E92923BDA9FC8EAABF792BA67`；cloud workflow 仍只允许 `Crazyfs` / `Flash-Night` 的固定 actor ID 首次 dispatch。
