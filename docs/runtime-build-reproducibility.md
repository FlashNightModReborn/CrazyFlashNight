...
当前 consensus 的 artifact source 为 `CF1C7759374353F827400183572778525C09AA109F4A3E022CE70D1C7CF9EDEE`、producer recipe `B97998EA7246D6AB667902BCBBD7994DFA5F658A37CFA427D2EEEABA6924DE28`、toolchain lock `7B83229BE93F8244810CDD23DAFD97875B23857E547DE520035FE23B453CB3CD`、policy `327041AD03E13CDB12E568C4EEC8CC82DA58A81E3B05A1BF5F670A937EED23A6`；build identity `D6AC04EB7EBE290819B41E2FE17DA7583F154FCB4D46BA258D17EF9866B74350`、payload closure `91C8AC7469EBF2788C9BDAF8AB13D8F3C02B59588D6B770F0DA6CAD1604DDF5B`、manifest SHA-256 `C5DFFDFE4A0C357618B297354A4EDA6CEB60DA88CF597350D81559AA56301846`、promotion 后 Windows worktree consensus bytes SHA-256 `01CA35867D9A5CC119670ACE6870D805001D7E2128D2F33044DC345E5B1473EF`。production policy receipt SHA-256 为 `FC0C96B57AA848D80465D2EB8DF546574C18911371C9F8BC1962A82E137577E4`；本地 X509 signer `EB5D32E04B6EE8697850314E19698DE1A3FACFFCCC6418A12CF7FEDE6033CDA5` / `physical-host-b` 与 GitHub OIDC builder `02D8940007301A2065FFF4DCF22160A7757232ECD91FF56A572FED9E95859F70` / `github-hosted-windows`（run `31246561049`）满足双 signer、双 faultDomain、production receipt 与 v2 strict/full-install verifier，于 `2026-08-08T08:32:12.9507783Z` 完成 promotion。队列为 ACL 收紧的 `C:\qpf58`；首次外层下载等待超时后只恢复同一 run id，没有重新 dispatch。

当前正式部署的 Core EXE SHA-256 为 `86DF1F5DC611037DB3A85FD9BA0D43490394F232D25A4F62B59AA4F2B4B6E4FD`，Core DLL SHA-256 为 `D5EDBA1277BB65D6741E9446415F2555D3D94BFD78723852E621F7366FB8616D`。无 candidate id 报告 `tmp/manual-agent-acceptance/workbench-v2/formal-workbench-20260808T083940Z.json`（SHA-256 `B114F3F91620DDA1067AA988C77D9E7A3C7CBB5BB8DF6E0E5BF91338C7BF752C`）取得 `acceptancePassed=true / runtimeMode=formal_runtime / wrapperExitCode=0`、Launcher/Help WebOverlay WGC、one-shot terminal receipt、可信 shutdown、专用存档字节不变与退出后无新增 Launcher/Core/Flash 进程。下行仍以“当前”描述 `730c6be781…` / `E203E4F…` 的段落均按上一列车历史输入阅读，不覆盖本段。
