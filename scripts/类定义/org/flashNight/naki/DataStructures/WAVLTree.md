...
搜索 100 个元素平均耗时: 0.72 毫秒
移除 100 个元素平均耗时: 1.35 毫秒
buildFromArray(100 个元素)平均耗时: 0.64 毫秒
changeCompareFunctionAndResort(100 个元素)平均耗时: 0.79 毫秒

容量: 1000，执行次数: 10
PASS: 所有元素移除后，size 应为0
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 WAVLTree 中
添加 1000 个元素平均耗时: 29.2 毫秒
搜索 1000 个元素平均耗时: 11.7 毫秒
移除 1000 个元素平均耗时: 16.6 毫秒
buildFromArray(1000 个元素)平均耗时: 6.2 毫秒
changeCompareFunctionAndResort(1000 个元素)平均耗时: 8.6 毫秒

容量: 10000，执行次数: 1
PASS: 所有元素移除后，size 应为0
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 WAVLTree 中
添加 10000 个元素平均耗时: 370 毫秒
搜索 10000 个元素平均耗时: 163 毫秒
移除 10000 个元素平均耗时: 264 毫秒
buildFromArray(10000 个元素)平均耗时: 62 毫秒
changeCompareFunctionAndResort(10000 个元素)平均耗时: 88 毫秒
