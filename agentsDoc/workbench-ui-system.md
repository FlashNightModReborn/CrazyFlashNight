...
**最后核对代码基线**：正式 runtime 事实仍绑定 commit `f01f4b121a4ceebd7dae051f14bb511c5ae3f1cb`（2026-07-30）及 tag `runtime-build-v2/20260730-workbench-no-as2-fallback-v1` / request `3BEBE136773D2C09022F01E5B3C176A788FE3D84E453F6500C6C560F03184C7B`；生产 consumer/count 曾于 2026-08-02 在 source `636a13ecca444842d0d717a94d1bbaf5d7187aca` 复核为历史 7-set，现由 2026-08-06 上游 source `c65f686857055ed5af2570068f00117e21ff2217` 的 9 个直接构造 exact-set 覆盖。正式 runtime identity 为 `58F1C3F3B128B22CEA4EDAEF74B402976D13ACB09D4A934240FCCFF3FA7C0465`，closure 为 `B529199F6CC00BC0687E8EED6950C6490F239C56E2A2D4AC27E90366CE2C8CAF`，Core 为 `565C1F9710421E6B6CC5CB6DDA05DE36B8F1B22B3D7A7CA19617F9786C7D8A4B`。标准入口 attempt `8baf52bbcceb452da32da641e58d2922` 仅验证 production Equipment Tuning opener → exact workbench instance → 同实例首个权威 snapshot → supported application shutdown；旧 AS2 工作台 fallback、Skill 无 token 兼容与 main legacy UI 可达边的退役字节已进入该冻结源码及配对 runtime，但不表示 Character、Materials、Intelligence、业务写、普通 panel close、持久化、剩余旧 CSS / G6+ 或整体整治得到专项验收。
