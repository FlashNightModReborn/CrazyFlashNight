...
添加 100 个元素平均耗时: 2.4 毫秒
搜索 100 个元素平均耗时: 0.73 毫秒
移除 100 个元素平均耗时: 1.32 毫秒
buildFromArray(100 个元素)平均耗时: 0.71 毫秒
...
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 WAVLTree 中
添加 1000 个元素平均耗时: 34.7 毫秒
搜索 1000 个元素平均耗时: 11.4 毫秒
移除 1000 个元素平均耗时: 20.3 毫秒
buildFromArray(1000 个元素)平均耗时: 5.8 毫秒
changeCompareFunctionAndResort(1000 个元素)平均耗时: 7.3 毫秒

容量: 10000，执行次数: 1
PASS: 所有元素移除后，size 应为0
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 WAVLTree 中
添加 10000 个元素平均耗时: 457 毫秒
搜索 10000 个元素平均耗时: 155 毫秒
移除 10000 个元素平均耗时: 294 毫秒
buildFromArray(10000 个元素)平均耗时: 56 毫秒
changeCompareFunctionAndResort(10000 个元素)平均耗时: 76 毫秒
