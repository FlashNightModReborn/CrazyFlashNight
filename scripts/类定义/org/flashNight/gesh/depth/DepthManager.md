...
=== AUTOMATION TEST ===
Time: Sat Mar 21 00:59:52 GMT+0800 2026
[DepthManagerTest] 
==================================================
...
[DepthManagerTest] ==================================================
[DepthManagerTest] 预生成随机数据: 5000 个 (种子=42, 可复现)
...
所有监听器已移除：onUnload，已恢复原生处理器。
目标对象的所有事件已清理，已释放 watch 拦截器。
[DepthManagerTest] DepthManager: 总 399ms / 2000 迭代 = 200 μs/帧（稳态）
[DepthManagerTest] ────── 性能对比（2000 迭代，50 实体） ──────
[DepthManagerTest]   裸 swapDepths : 62 μs/帧
[DepthManagerTest]   DepthManager  : 200 μs/帧
[DepthManagerTest]   倍率          : 3.23x
[DepthManagerTest]   开销          : 224.4%
[DepthManagerTest] × 开销 224.4%，需进一步优化
[DepthManagerTest] 旧方案基线: 27.15ms/20迭代 ≈ 1358 μs/帧
[DepthManagerTest] √ 新方案优于旧方案 (7x 加速)
[DepthManagerTest] 
==================================================
[DepthManagerTest]  测试总结
[DepthManagerTest] ==================================================
[DepthManagerTest] 功能测试:
[DepthManagerTest] - 总测试数: 21
[DepthManagerTest] - 通过: 21
