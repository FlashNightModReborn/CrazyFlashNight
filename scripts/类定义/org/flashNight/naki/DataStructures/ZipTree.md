...
搜索 100 个元素平均耗时: 1.65 毫秒
移除 100 个元素平均耗时: 1.68 毫秒
buildFromArray(100 个元素)平均耗时: 1.78 毫秒
changeCompareFunctionAndResort(100 个元素)平均耗时: 1.87 毫秒

容量: 1000，执行次数: 10
PASS: 所有元素移除后，size 应为0
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 ZipTree 中
添加 1000 个元素平均耗时: 19 毫秒
搜索 1000 个元素平均耗时: 28 毫秒
移除 1000 个元素平均耗时: 27.7 毫秒
buildFromArray(1000 个元素)平均耗时: 21.5 毫秒
changeCompareFunctionAndResort(1000 个元素)平均耗时: 22.9 毫秒

容量: 10000，执行次数: 1
PASS: 所有元素移除后，size 应为0
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 ZipTree 中
添加 10000 个元素平均耗时: 249 毫秒
搜索 10000 个元素平均耗时: 312 毫秒
移除 10000 个元素平均耗时: 274 毫秒
buildFromArray(10000 个元素)平均耗时: 235 毫秒
changeCompareFunctionAndResort(10000 个元素)平均耗时: 251 毫秒
