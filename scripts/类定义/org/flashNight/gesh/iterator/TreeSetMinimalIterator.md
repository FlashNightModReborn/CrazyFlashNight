...
测试规模: 5000 个元素
────────────────────────────────────────────────────────────────
  构建 TreeSet 耗时: 172 ms
  迭代器遍历: 57 ms (count=5000)
  toArray遍历: 7 ms (length=5000)
  后继搜索(3轮半遍历): 27 ms (avg)
...
测试规模: 10000 个元素
────────────────────────────────────────────────────────────────
  构建 TreeSet 耗时: 363 ms
  迭代器遍历: 116 ms (count=10000)
  toArray遍历: 13 ms (length=10000)
  后继搜索(3轮半遍历): 56 ms (avg)
...
测试规模: 50000 个元素
────────────────────────────────────────────────────────────────
  构建 TreeSet 耗时: 2145 ms
  迭代器遍历: 653 ms (count=50000)
  toArray遍历: 70 ms (length=50000)
  后继搜索(3轮半遍历): 317 ms (avg)
