...
**最后核对代码基线**：关卡结果与基地结算 release source commit `732898b8aa1308cf820976324f47bba97f654e41`（2026-08-27；deployment `339b15694d631d483736880c0dfd44429f6926a3`）；正式 runtime 身份、共识与证据见 [runtime 构建复现文档](docs/runtime-build-reproducibility.md)。
