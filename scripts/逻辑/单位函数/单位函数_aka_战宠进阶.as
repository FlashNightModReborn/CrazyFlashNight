...
_root.战宠进阶函数.溢出治疗 = {
	...
	描述:function(){
		...
		return "点击可解锁"+this.进阶方案.溢出治疗.名称+"，在治疗目标满血后依然可以额外治疗一定比例hp值，并跟随“白”的等级提升比例。同时将提升“白”的hp值。需要消耗"+ this.进阶方案.溢出治疗.消耗金币+"金币";
	},
	详情页:true,
	执行按钮文字:"解锁能力",
	背景:"武术",
	详情页描述:function(){
		var 基础介绍 = "采用更先进的医疗手段与治疗药剂。<br>提升自身hp，并解锁"+this.进阶方案.溢出治疗.名称+"，在治疗目标满血后依然可以额外治疗至120%的hp值，跟随“白”的等级可提升至最高150%的溢出治疗幅度。"
		if(this.当前宠物信息[1] < this.进阶方案.溢出治疗.解锁等级){
