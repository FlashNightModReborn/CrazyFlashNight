...
**文档角色**：启动与运行自动化入口。  
**当前正式列车（2026-08-25，限时关卡 TimePool）**：release source `a4a85dbdcb266f66677eef28875e0862892e48ad`、tag `runtime-build-v2/20260825-stage-time-pools-v3`、release tree `0b4778aa346a6acce276052debf79a93af7a39a1` 与 request `ADDBA21EF66AA9429D00D349E0ACD33F27BE55641CB3B9F541ACB6BEAC47D043` 已由本地 X509 `builder-local-a` / `physical-host-a` 与 GitHub OIDC/Sigstore `github-hosted-windows`（cloud run `32837546069`）对 identity `50ED16457B8C82787A495F957259A9544AD96C819E8D1EF11087D5AF06E0BFB0`、closure `60981913A1D18682C06B6ABF2CC6DB7EC0F57345BAF8B1D372E67D7EC3ADE5EB` 达成双 signer / 双 faultDomain 共识。39/39 final receipt SHA-256 为 `F69E8A0569838920B86A42F3B704EABFEEF5AE4E6193A6389FB97055DDDAD9B4`；deployment commit `9f68a3ee5fbd6db9447118da12fa0fa0a00d1829` 与 post-promotion audit run `32838658629` 均已推送/通过。
无 candidate selector 的 formal runtime attempt `eb0d6743820512eccccfc6138cdf5605` 取得 fresh reveal、两次同 lifecycle `session.status=verified`、精确 identity/closure、strict shutdown、Flash/Guardian exit 0、玩家调制档哈希不变与零进程/会合点/凭据残留。该窄 smoke 证明正式入口身份和生命周期，不含限时关卡业务；维护者已确认限时行为有效，因此当前是限时关卡 `HUMAN_ACCEPTANCE_PASSED / promoted`、正式入口身份/生命周期窄纵切 `standard_entry_verified`，不称限时关卡业务 `standard_entry_verified`。第一次过早 shutdown 的 attempt `2a76b07b8223dc3d249366df2d3c5365` 严格保留为失败计时证据，未被成功 attempt 覆盖。
