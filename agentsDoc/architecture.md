...
**最后核对代码基线**：commit `c96f4c3d750561022b706c72a4d53050431e627d`（2026-07-29），并核对本轮施工树中已通过专项自动门的 Host 浏览器策略、整备 B1–B7 与 Native 右侧条件槽；这些施工树变化尚未部署，高变动功能、构建与验收状态仍以对应专题 canonical doc 为准。
