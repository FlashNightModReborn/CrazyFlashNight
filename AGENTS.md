...
**最后核对代码基线**：设置 Web Panel release source commit `d6684d441f134553ec56590ed975388dff06f1bd`（tag `runtime-build-v2/20260822-settings-web-panel-v1`）、release tree `34b3ef11ff9d8ab6a32fed67da3ee30bf7015606`、request `9B9982BB290DF8E0132F52DD4CA842100E9003FB6ADAB71908D5797FB3C198D7` 已由本地 X509 `builder-local-b` / `physical-host-b` 与 GitHub OIDC/Sigstore `github-hosted-windows`（cloud run `32512318147`）完成 v2 双 signer/双故障域 promotion；正式 runtime 绑定 identity `AD4B23A7489EB011EA4FC54004DC343F4FA5AF1FCA1D3BBD9452760D18EF1D78`、closure `24747E9C71B31E1D7A82356D028A88C3D741CA7AF71D10AC2C97A920649A6051`、Core DLL SHA-256 `54A0833082AD3394E002F2E1BD512C6027E6D30CFFEC9D80AC1AEAA1C9515ECF`，38/38 production receipt SHA-256 `2B5E2C328667A7E05649B5D6A32497920DC68EB428680819907E89F39F0C2211`；promotion commit `de24f449fba0f004193392a273d09b875a4c3935` 与 post-promotion audit run `32513484781` 均已推送/通过，审计明确输出 `state=promoted`、`deploymentChanged=true`。

**状态边界**：设置专项已完成维护者人工观感验收、Settings Node 16/16、Edge 100/100、Launcher 3931 pass + 3 explicit opt-in skip / 3934 total、Agent Runtime Node 38/38、fresh AS2 36/36 与手动输入 474/474 + 50/50 + 19/19；部署后无 candidate-id 的正式 Agent Runtime 又以 exact `settings_camera_preview` 打开 1600×900 WebOverlay WGC，并取得可信 shutdown，因此该单屏设置诊断入口窄纵切称 `standard_entry_verified`。该结论不外推为 Flash pixels/input、真实玩家存档写入/重启、物理 WebView2 键鼠、音量听感、救援业务效果或全游戏 E2E。字体 Gate E 仍保持 14 asset / 14 face / 28 role / 9 preset 与 `GATE_E_COMPLETE / promoted`，其第三方字体法律意见和 post-promotion 业务标准入口仍未补；旧列车明细统一留在 [runtime-build-reproducibility.md](docs/runtime-build-reproducibility.md)，Audio H2 继续作为专项 `pending`。
