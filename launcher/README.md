...
> **当前源码边界**：审阅/F0 锚点 `c96f4c3d750561022b706c72a4d53050431e627d` 之后的 A2b、A3、B1–B7、C1–C3、E、G1–G5、H1–H6、双宿主浏览器策略、Native 右侧条件槽，以及旧 AS2 工作台 fallback / Skill 无 token 兼容 / main legacy UI 可达边的退役，现已包含在 `f01f4b121a4c…` 冻结 tree 与正式 runtime。自动门和总体 promotion 不等于所有功能都完成该 release identity 下的专项实机验收；本轮正式入口只覆盖上述 Equipment Tuning opener/snapshot 窄纵切。
