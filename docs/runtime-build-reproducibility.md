...
当前 consensus 精确绑定 request `2EE9A1E09A07A93EE2B7D49D74BCCDFE71A6953E290AB7C8D6A58BC460DAC4A0` 与 release tree `978eaa7e75708b82fd8d57b9f8c63b11f5e689cb`。artifact source 为 `A1397D641FD5B31D38074176CBF6D60B0BC81B05A1348D6C81B375B7C924311E`、producer recipe `93A007D1BD03C54F3CC257F1E4610354BBBB83C97B635AC28C2B5D393C75868A`、toolchain lock `7B83229BE93F8244810CDD23DAFD97875B23857E547DE520035FE23B453CB3CD`、policy `D19EFCA5209429CB6F47DE12186F344AAC598F2DDAD8E8E0325456CFEA3543AB`；build identity `74D14EE3A17CD12AE5F74CB6779CF702339E4D22E3F6C6523F1E9C72EFA04CA3`、payload closure `2F6B950B64441E1378A687549638464D420C255251D517EA935D866021D6D1CC`、manifest SHA-256 `74A0BBA3F2AB8EED800B46AEFD01C6B6FEA01BA359D76C74C9BA46A96CB32A6E`、promotion 后 Windows worktree consensus bytes SHA-256 `ED17B2BF87606E14D340A4263769C14C8290A2C9BC251911DE6F1AD44514681B`。production policy receipt SHA-256 为 `F9729CDEF8BC7017FBE14AE0B561E7F4DC739CD6DF9B2E3E97FE95737AB2F6B5`；本地 X509 signer `EB5D32E04B6EE8697850314E19698DE1A3FACFFCCC6418A12CF7FEDE6033CDA5` / `physical-host-b` 与 GitHub OIDC builder `8C0233C1268C0AAE6ADBAB159B65CB14402683E6F6C05C37F53DD7AAFF57E44C` / `github-hosted-windows`（run `31892519833`）满足双 signer、双 faultDomain、production receipt 与 v2 strict/full-install verifier，于 `2026-08-15T16:37:35Z` 完成 promotion。

当前正式部署的根 EXE SHA-256 为 `55EABB5C3280FDFEE8302843D969C6B6354808F1AF4DC24DB5E2397AA80499D8`（未变），Core DLL SHA-256 为 `73579C43BF6DFDF97B9EC5158A6492BFF3C1AC67357AA5A7D06B3B77BE6F4697`，`miniaudio.dll` SHA-256 为 `AC3A8FC3BE306D595918F392B44E298D95B71221311920E892C4BE2A6E3AD20A`（未变）。部署后 33-file bundle、signed consensus 与正式根入口 `--verify-only` 分别通过；post-promotion audit run `31897530643` 精确报告 base `29ab59fd78…`、head `a469f487f0…`、`state=promoted`。本轮未完成面板或 Audio 专项正式旅程，因此不声称对应 `standard_entry_verified`，也不外推任何业务写或玩家目视签收。下行仍以“当前”描述旧 source / identity 的段落均按历史列车输入阅读，不覆盖本段。
