...
2026-08-17 当前树的 Crafting browser 三视口各为 baseline `150/150` + current `15/15` + owner `8/8` + identity `10/10` + v1 `6/6` + session-lock `9/9` + recipe-jump `26/26` + material-shop `12/12` + infrastructure `9/9` + procurement `17/17`，并有 Crafting runtime `36/36`、Panel runtime `41/41`、NPC `130/130 + 23/23 + 2/2` 与 KShop `151/151`。其中 procurement journey 固定断言配方直达不发材料目录/详情预检、28px 单层材料/商店/合成入口，以及嵌套配方同分类零 snapshot 精确聚焦、跨分类 exact snapshot 切换；NPC 定向 journey 另覆盖 recipe-origin 精确定位与返回意图。这些仍只证明 mock-browser/Node closure，不代签真实 WebView2→Flash、游戏内 E2E、candidate、promotion 或部署。
