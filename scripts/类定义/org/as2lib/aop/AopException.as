...
/**
 * {@code AopException} is the base exception of the AOP API. This exception is
 * extended by every exception of the AOP API.
 *
 * @author Simon Wacker
 */
class org.as2lib.aop.AopException extends Exception {
	...
	/**
	 * Constructs a new {@code AopException} instance.
	 *
