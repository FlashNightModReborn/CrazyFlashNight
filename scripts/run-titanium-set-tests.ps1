...
$focusedRun = @{
    ...
    ExpectedTracePatterns = @('(?m)^TitaniumSetRuntimeTest Tests Passed: 145\r?$', '(?m)^TitaniumSetRuntimeTest Tests Failed: 0\r?$')
    SuccessSummary = '钛合金S1/S2 145/145：五甲能源、双枪闭环、真实换弹、171快照与状态反馈'
