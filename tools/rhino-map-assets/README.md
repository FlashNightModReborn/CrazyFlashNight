...
| 地点 | 车号 | 地面世界坐标 | 姿态 |
|---|---:|---|---|
| 外交军阀基地帐篷后 | 25、27 | (640,165)、(1780,185) | 左向平射，前排帐篷遮挡 |
...
外交基地26号位置现由猛虎41号接替；高地犀牛右移140px，为猛虎替换卡车留出间距。见 [猛虎装配](../tigr-map-assets/README.md)。同时同步两种车时，先执行本工具，再执行猛虎工具，最后运行两者检查。
