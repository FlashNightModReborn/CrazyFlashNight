...
PASS: [wavl] 所有添加的元素都应成功移除
PASS: [wavl] 所有添加的元素都应存在于 TreeSet 中
添加 1000 个元素平均耗时: 21.2 毫秒
搜索 1000 个元素平均耗时: 8.5 毫秒
移除 1000 个元素平均耗时: 13.5 毫秒
...
PASS: [wavl] 所有添加的元素都应成功移除
PASS: [wavl] 所有添加的元素都应存在于 TreeSet 中
添加 10000 个元素平均耗时: 269 毫秒
搜索 10000 个元素平均耗时: 117 毫秒
移除 10000 个元素平均耗时: 192 毫秒
...
添加 最优: Zip (15ms) | 最差: LLRB (66ms)
搜索 最优: AVL (8ms) | 最差: Zip (15ms)
删除 最优: WAVL (13ms) | 最差: LLRB (135ms)
构建 最优: AVL (5ms) | 最差: LLRB (68ms)
...
添加 最优: Zip (156ms) | 最差: LLRB (904ms)
搜索 最优: AVL (114ms) | 最差: Zip (222ms)
删除 最优: WAVL (186ms) | 最差: LLRB (2055ms)
构建 最优: AVL (44ms) | 最差: LLRB (920ms)
...
添加 最优: Zip (1639ms) | 最差: LLRB (11104ms)
搜索 最优: RB (1426ms) | 最差: Zip (3262ms)
删除 最优: WAVL (2605ms) | 最差: LLRB (26740ms)
构建 最优: AVL (436ms) | 最差: LLRB (11248ms)
