...
--- parse 性能基准（等价路径 + 基线扣除） ---
  ...
  小(10项) | 895 字符
    ...
    LiteJSON:     0.729 ms/次 | 192 次/轮 | 中位总 140.00 ms | 1.17 MB/s | 波动 1.02x
    FastJSON(失配): 1.070 ms/次 | 8 批/轮 x32 = 256 次 | 中位总 274.00 ms | 0.80 MB/s | 波动 1.02x
    FastJSON(严冷): 1.109 ms/次 | 8 批/轮 x32 = 256 次 | 中位总 284.00 ms | 0.77 MB/s | 波动 1.07x
    FastJSON(热): 3.22 us/次 | 50000 次/轮 | 中位总 161.00 ms | 265.07 MB/s | 波动 1.03x
    --
    JSON / LiteJSON = 4.63x
    LiteJSON / FastJSON(严冷) = 0.66x
    FastJSON 严冷 / 失配 = 1.04x
    FastJSON 失配 / 热 = 332.40x
    FastJSON 严冷 / 热 = 344.53x

  中(50项) | 4035 字符
    JSON:         15.063 ms/次 | 16 次/轮 | 中位总 241.00 ms | 0.26 MB/s | 波动 1.02x
    LiteJSON:     3.208 ms/次 | 48 次/轮 | 中位总 154.00 ms | 1.20 MB/s | 波动 1.05x
    FastJSON(失配): 4.727 ms/次 | 4 批/轮 x64 = 256 次 | 中位总 1210.00 ms | 0.81 MB/s | 波动 1.01x
    FastJSON(严冷): 4.695 ms/次 | 4 批/轮 x64 = 256 次 | 中位总 1202.00 ms | 0.82 MB/s | 波动 1.02x
    FastJSON(热): 8.93 us/次 | 14336 次/轮 | 中位总 128.00 ms | 430.98 MB/s | 波动 1.02x
    --
    JSON / LiteJSON = 4.69x
    LiteJSON / FastJSON(严冷) = 0.68x
    FastJSON 严冷 / 失配 = 0.99x
    FastJSON 失配 / 热 = 529.38x
    FastJSON 严冷 / 热 = 525.88x

  大(200项) | 16244 字符
    JSON:         59.333 ms/次 | 3 次/轮 | 中位总 178.00 ms | 0.26 MB/s | 波动 1.05x
    LiteJSON:     13.125 ms/次 | 16 次/轮 | 中位总 210.00 ms | 1.18 MB/s | 波动 1.02x
    FastJSON(失配): 18.727 ms/次 | 2 批/轮 x64 = 128 次 | 中位总 2397.00 ms | 0.83 MB/s | 波动 1.01x
    FastJSON(严冷): 18.867 ms/次 | 2 批/轮 x64 = 128 次 | 中位总 2415.00 ms | 0.82 MB/s | 波动 1.01x
    FastJSON(热): 31.25 us/次 | 4096 次/轮 | 中位总 128.00 ms | 495.73 MB/s | 波动 1.03x
    --
    JSON / LiteJSON = 4.52x
    LiteJSON / FastJSON(严冷) = 0.70x
    FastJSON 严冷 / 失配 = 1.01x
    FastJSON 失配 / 热 = 599.25x
    FastJSON 严冷 / 热 = 603.75x
...
--- stringify 性能基准（等价路径 + 基线扣除） ---
  ...
  小(10项) | 约 895 输出字符
    JSON:         0.98 us/次 | 65536 次/轮 | 中位总 64.00 ms | 874.02 MB/s | 波动 1.08x
    LiteJSON:     3.97 us/次 | 32768 次/轮 | 中位总 130.00 ms | 215.14 MB/s | 波动 1.13x
    FastJSON(失配): 7.51 us/次 | 1024 批/轮 x32 = 32768 次 | 中位总 246.00 ms | 113.69 MB/s | 波动 1.03x
    FastJSON(严冷): 12.15 us/次 | 1024 批/轮 x32 = 32768 次 | 中位总 398.00 ms | 70.27 MB/s | 波动 1.04x
    FastJSON(热): 2.86 us/次 | 50000 次/轮 | 中位总 143.00 ms | 298.44 MB/s | 波动 1.03x
    --
    JSON / LiteJSON = 0.25x
  ...
  中(50项) | 约 4035 输出字符
    JSON:         0.95 us/次 | 32768 次/轮 | 中位总 31.00 ms | 4067.54 MB/s | 波动 1.07x
    LiteJSON:     4.03 us/次 | 32768 次/轮 | 中位总 132.00 ms | 955.26 MB/s | 波动 1.03x
    FastJSON(失配): 7.48 us/次 | 512 批/轮 x64 = 32768 次 | 中位总 245.00 ms | 514.67 MB/s | 波动 1.04x
    FastJSON(严冷): 12.63 us/次 | 512 批/轮 x64 = 32768 次 | 中位总 414.00 ms | 304.57 MB/s | 波动 1.02x
    FastJSON(热): 2.87 us/次 | 30000 次/轮 | 中位总 86.00 ms | 1342.35 MB/s | 波动 1.07x
    --
    JSON / LiteJSON = 0.23x
    LiteJSON / FastJSON(严冷) = 0.32x
    FastJSON 严冷 / 失配 = 1.69x
    FastJSON 失配 / 热 = 2.61x
    FastJSON 严冷 / 热 = 4.41x

  大(200项) | 约 16244 输出字符
    JSON:         低于计时分辨率 | 8192 次/轮 | 中位总 8.00 ms | 15863.28 MB/s | 波动 1.29x | 原始/基线 9.00/1.00 ms | 低置信度
    LiteJSON:     3.78 us/次 | 8192 次/轮 | 中位总 31.00 ms | 4093.75 MB/s | 波动 1.10x
    FastJSON(失配): 7.51 us/次 | 512 批/轮 x64 = 32768 次 | 中位总 246.00 ms | 2063.52 MB/s | 波动 1.03x
    FastJSON(严冷): 12.49 us/次 | 384 批/轮 x64 = 24576 次 | 中位总 307.00 ms | 1240.13 MB/s | 波动 1.03x
    FastJSON(热): 2.75 us/次 | 12000 次/轮 | 中位总 33.00 ms | 5633.27 MB/s | 波动 1.13x
    --
    JSON / LiteJSON = n/a（低置信度）
    LiteJSON / FastJSON(严冷) = 0.30x
...
--- FastJSON 缓存专项（中规模） ---
  ...
  parse
    失配: 4.813 ms/次 | 4 批/轮 x64 = 256 次 | 中位总 1232.00 ms | 0.80 MB/s | 波动 1.01x
    严冷: 4.855 ms/次 | 4 批/轮 x64 = 256 次 | 中位总 1243.00 ms | 0.79 MB/s | 波动 1.02x
    热: 9.07 us/次 | 14336 次/轮 | 中位总 130.00 ms | 424.35 MB/s | 波动 1.02x
    严冷 / 失配 = 1.01x
    失配 / 热 = 530.71x
    严冷 / 热 = 535.45x
  stringify
    失配: 7.39 us/次 | 512 批/轮 x64 = 32768 次 | 中位总 242.00 ms | 521.05 MB/s | 波动 1.03x
    严冷: 12.36 us/次 | 512 批/轮 x64 = 32768 次 | 中位总 405.00 ms | 311.34 MB/s | 波动 1.03x
    热: 2.83 us/次 | 30000 次/轮 | 中位总 85.00 ms | 1358.14 MB/s | 波动 1.10x
    严冷 / 失配 = 1.67x
    失配 / 热 = 2.61x
    严冷 / 热 = 4.36x
