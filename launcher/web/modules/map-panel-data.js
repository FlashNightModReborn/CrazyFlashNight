var MapPanelData = (function() {
    ...
    var _pageStaticAvatars = {
        base: buildStaticAvatarSlots([
            ['pig_avatar', 'Pig', 'base_garage', 'pig头像.webp'],
            ['boy_avatar', 'Boy', 'base_garage', 'boy头像.webp'],
            ['king_avatar', 'King', 'base_garage', 'king头像.webp'],
            ['weapon_merchant_avatar', '冷兵器商人', 'base_garage', '冷兵器商人头像.webp'],
            ['shamate_avatar', '杀马特', 'base_lobby', '∞天ㄙ★使的剪∞头像.webp'],
            ['bartender_avatar', '酒保', 'merc_bar', '酒保头像.webp'],
            ['wizard_avatar', '格格巫', 'infirmary', '格格巫头像.webp'],
            ['lilith_avatar', '丽丽丝', 'infirmary', '丽丽丝头像.webp'],
            ['dancer_avatar', '舞女', 'merc_bar', '舞女头像.webp'],
            ['gem_contact_avatar', '宝石线人', 'base_lobby', '宝石线人头像.webp'],
            ['sheriff_avatar', '前治安官', 'base_lobby', '前治安官头像.webp'],
            ['diplomat_avatar', '黑铁会外交部长', 'base_lobby', '黑铁会外交部长头像.webp'],
            ['schoolgirl_avatar', '学生妹', 'base_lobby', '学生妹头像.webp'],
            ['veteran_avatar', '幸存老兵', 'base_lobby', '幸存老兵头像.webp'],
            ['thegirl_avatar', 'The Girl', 'basement1', 'the girl头像.webp'],
            ['andy_avatar', 'Andy Law', 'basement1', 'andy头像.webp'],
            ['shopgirl_avatar', 'Shop Girl', 'armory', 'shopgirl头像.webp'],
            ['blue_avatar', 'Blue', 'basement1', 'blue头像.webp'],
            ['xiaof_avatar', '小F', 'armory', '小F头像.webp'],
            ['chef_avatar', '厨师', 'cafeteria', '厨师头像.webp'],
            ['master_swordman_gym_avatar', '武器大师', 'gym', '武器大师头像.webp']
        ]),
        faction: buildStaticAvatarSlots([
            ['general_avatar', 'general', 'warlord_base', 'general头像.webp'],
            ['gazer_avatar', 'gazer', 'warlord_base', 'gazer头像.webp'],
            ['director_avatar', 'director', 'warlord_tent', 'director头像.webp'],
            ['itinerant_avatar', 'itinerant', 'firing_range', 'itinerant头像.webp'],
            ['surveyor_avatar', 'surveyor', 'firing_range', 'surveyor头像.webp'],
            ['singer_avatar', 'singer', 'rock_park', 'singer头像.webp'],
            ['keyboard_avatar', 'keyboard', 'rock_park', 'keyboard头像.webp'],
            ['guitar_avatar', 'guitar', 'rock_park', 'guitar头像.webp'],
            ['firephoenix_avatar', '火凤', 'blackiron_training', '火凤头像.webp'],
            ['wingtiger_avatar', '翅虎', 'blackiron_training', '翅虎头像.webp'],
            ['blackdragon_avatar', '黑龙', 'blackiron_training', '黑龙头像.webp'],
            ['blackiron_avatar', '黑铁', 'blackiron_pavilion', '黑铁头像.webp'],
            ['cowboy_avatar', '牛仔', 'fallen_bar', '牛仔头像.webp'],
            ['cyborg_sage_avatar', '假肢仙人', 'fallen_street', '假肢仙人头像.webp'],
            ['hitler_avatar', '吸特乐', 'fallen_street', '吸特乐头像.webp'],
            ['researcher_avatar', 'researcher', 'fallen_street', 'researcher头像.webp'],
            ['bartender_fallen_avatar', '调酒师', 'fallen_bar', '调酒师头像.webp']
        ]),
        defense: buildStaticAvatarSlots([
            ['artist_avatar', 'artist', 'first_defense', 'artist头像.webp'],
            ['soldier_avatar', 'soldier', 'first_defense', 'soldier头像.webp'],
            ['sheriff_first_defense_avatar', '前治安官', 'first_defense', '前治安官头像.webp', { relX: 220, relY: 55 }],
            ['master_swordman_first_defense_avatar', '武器大师', 'first_defense', '武器大师头像第一防线.webp'],
            ['paigu_avatar', '排骨', 'alliance_dock', '排骨头像.webp'],
            ['jige_avatar', '机哥', 'alliance_dock', '机哥头像.webp'],
            ['abo_avatar', '阿波', 'alliance_dock', '阿波头像.webp'],
            ['prophet_avatar', 'PROPHET', 'alliance_corridor', 'PROPHET头像.webp']
        ]),
        school: buildStaticAvatarSlots([
            ['heizi_avatar', '黑仔', 'union_university', '黑仔头像.webp'],
            ['bat_avatar', 'Bat', 'union_university', 'Bat头像.webp'],
            ['tomboy_avatar', 'Tomboy', 'union_university', 'Tomboy头像.webp'],
            ['weapon_order_avatar', '武器订购系统', 'union_university', '武器订购系统头像.webp'],
            ['pe_teacher_avatar', '体育老师', 'university_interior', '体育老师头像.webp'],
            ['chengzheng_avatar', '程铮', 'teaching_interior', '程铮头像.webp'],
            ['kendo_president_avatar', '剑道社长', 'kendo_club', '剑道社长头像.webp'],
            ['fengyouquan_avatar', '冯佑权', 'kendo_club', '冯佑权头像.webp'],
            ...
            ['science_prof_avatar', '理科教授', 'science_class', '理科教授头像.webp'],
            ['arts_teacher_avatar', '文科老师', 'arts_class', '文科老师头像.webp'],
            ['vanshuther_avatar', 'Vanshuther', 'workshop', 'Vanshuther头像.webp'],
            ['dean_avatar', '教导主任', 'office', '教导主任头像.webp']
        ])
    };
    ...
    var _pages = {
        base: {
            ...
            backdropTheme: 'base',
            backgroundUrl: 'assets/map/page-base.webp',
            width: 1031,
            height: 608,
            sceneVisuals: [
                { id: 'base_roof_visual', label: '基地屋顶', assetUrl: 'assets/map/composite/base/base-roof.webp', rect: { x: 211.6, y: 95.25, w: 471.05, h: 179.25 }, filterIds: ['roof', 'all', 'hierarchy'], hotspotIds: ['base_roof'] },
                { id: 'merc_bar_visual', label: '佣兵酒吧', assetUrl: 'assets/map/composite/base/merc-bar.webp', rect: { x: 295.1, y: 65.9, w: 216.25, h: 125.44 }, filterIds: ['first_floor', 'all', 'hierarchy'], hotspotIds: ['merc_bar'] },
                { id: 'infirmary_visual', label: '医务室', assetUrl: 'assets/map/composite/base/infirmary.webp', rect: { x: 496.55, y: 95.2, w: 156.52, h: 123.5 }, filterIds: ['first_floor', 'all', 'hierarchy'], hotspotIds: ['infirmary'] },
                { id: 'dormitory_visual', label: '宿舍', assetUrl: 'assets/map/composite/base/dormitory.webp', rect: { x: 475.85, y: 56.2, w: 133.93, h: 100.91 }, filterIds: ['first_floor', 'all', 'hierarchy'], hotspotIds: ['dormitory'] },
                { id: 'base_garage_visual', label: '基地车库', assetUrl: 'assets/map/composite/base/base-garage.webp', rect: { x: 33.3, y: 134.25, w: 290, h: 156.87 }, filterIds: ['first_floor', 'all', 'hierarchy'], hotspotIds: ['base_garage'] },
                { id: 'base_lobby_visual', label: '基地大厅', assetUrl: 'assets/map/composite/base/base-lobby.webp', rect: { x: 223.35, y: 146.7, w: 441.94, h: 142.76 }, filterIds: ['first_floor', 'all', 'hierarchy'], hotspotIds: ['base_lobby'] },
                { id: 'base_entrance_visual', label: '基地门口', assetUrl: 'assets/map/composite/base/base-entrance.webp', rect: { x: 622.65, y: 151.3, w: 289.54, h: 137.49 }, filterIds: ['first_floor', 'all', 'hierarchy'], hotspotIds: ['base_entrance'] },
                { id: 'basement1_visual', label: '地下一层', assetUrl: 'assets/map/composite/base/basement1.webp', rect: { x: 337.55, y: 257.4, w: 333.2, h: 121.98 }, filterIds: ['basement1', 'all', 'hierarchy'], hotspotIds: ['basement1'] },
                { id: 'gym_visual', label: '健身房', assetUrl: 'assets/map/composite/base/gym.webp', rect: { x: 221.25, y: 257.4, w: 199.87, h: 120.98 }, filterIds: ['basement1', 'all', 'hierarchy'], hotspotIds: ['gym'] },
                { id: 'armory_visual', label: '武器库', assetUrl: 'assets/map/composite/base/armory.webp', rect: { x: 459.65, y: 217.9, w: 198.61, h: 120.98 }, filterIds: ['basement1', 'all', 'hierarchy'], hotspotIds: ['armory'] },
                { id: 'cafeteria_visual', label: '食堂', assetUrl: 'assets/map/composite/base/cafeteria.webp', rect: { x: 44.6, y: 314.05, w: 399.62, h: 159.39 }, filterIds: ['basement2', 'all', 'hierarchy'], hotspotIds: ['cafeteria'] },
                { id: 'corridor_visual', label: '走廊', assetUrl: 'assets/map/composite/base/corridor.webp', rect: { x: 329, y: 348.55, w: 197.46, h: 121.66 }, filterIds: ['basement2', 'all', 'hierarchy'], hotspotIds: ['corridor'] },
                { id: 'lab_visual', label: '实验室', assetUrl: 'assets/map/composite/base/lab.webp', rect: { x: 496.1, y: 317.35, w: 219.99, h: 153.01 }, filterIds: ['basement2', 'all', 'hierarchy'], hotspotIds: ['lab'] },
                { id: 'underground_water_visual', label: '地下水', assetUrl: 'assets/map/composite/base/underground-water.webp', rect: { x: 328.25, y: 418.65, w: 170.17, h: 113.41 }, filterIds: ['water', 'all', 'hierarchy'], hotspotIds: ['underground_water'] }
            ],
        ...
        faction: {
            ...
            backgroundUrl: 'assets/map/page-faction.webp',
            width: 1031,
            height: 608,
            sceneVisuals: [
                { id: 'warlord_base_visual', label: '军阀基地', assetUrl: 'assets/map/composite/faction/warlord-base.webp', rect: { x: 26.35, y: 85.4, w: 240.25, h: 125.08 }, filterIds: ['warlord', 'all'], hotspotIds: ['warlord_base'] },
                { id: 'warlord_tent_visual', label: '军阀帐篷', assetUrl: 'assets/map/composite/faction/warlord-tent.webp', rect: { x: 40.6, y: 33.15, w: 193.16, h: 115.48 }, filterIds: ['warlord', 'all'], hotspotIds: ['warlord_tent'] },
                { id: 'firing_range_visual', label: '靶场', assetUrl: 'assets/map/composite/faction/firing-range.webp', rect: { x: 20.75, y: 170.05, w: 248.3, h: 148.26 }, filterIds: ['warlord', 'all'], hotspotIds: ['firing_range'] },
                { id: 'rock_park_visual', label: '摇滚公园', assetUrl: 'assets/map/composite/faction/rock-park.webp', rect: { x: 305.05, y: 55, w: 284, h: 145 }, filterIds: ['rock', 'all'], hotspotIds: ['rock_park'] },
                { id: 'rock_rehearsal_visual', label: '摇滚排练室', assetUrl: 'assets/map/composite/faction/rock-rehearsal.webp', rect: { x: 318.3, y: 193.7, w: 262, h: 127 }, filterIds: ['rock', 'all'], hotspotIds: ['rock_rehearsal'] },
                { id: 'blackiron_training_visual', label: '黑铁会修炼场', assetUrl: 'assets/map/composite/faction/blackiron-training.webp', rect: { x: 600, y: 50, w: 280, h: 94 }, filterIds: ['blackiron', 'all'], hotspotIds: ['blackiron_training'] },
                { id: 'blackiron_pavilion_visual', label: '黑铁阁', assetUrl: 'assets/map/composite/faction/blackiron-pavilion.webp', rect: { x: 600, y: 160, w: 280, h: 127 }, filterIds: ['blackiron', 'all'], hotspotIds: ['blackiron_pavilion'] },
                { id: 'fallen_street_visual', label: '堕落城商业街', assetUrl: 'assets/map/composite/faction/fallen-street.webp', rect: { x: 20, y: 392.15, w: 212, h: 139 }, filterIds: ['fallen', 'all'], hotspotIds: ['fallen_street'] },
                { id: 'fallen_entrance_visual', label: '堕落城酒吧门口', assetUrl: 'assets/map/composite/faction/fallen-entrance.webp', rect: { x: 257, y: 395, w: 275, h: 140 }, filterIds: ['fallen', 'all'], hotspotIds: ['fallen_entrance'] },
                { id: 'fallen_bar_visual', label: '堕落城酒吧', assetUrl: 'assets/map/composite/faction/fallen-bar.webp', rect: { x: 557, y: 389.15, w: 240, h: 138 }, filterIds: ['fallen', 'all'], hotspotIds: ['fallen_bar'] }
            ],
        ...
        defense: {
            ...
            backgroundUrl: 'assets/map/page-defense.webp',
            width: 1031,
            height: 608,
            sceneVisuals: [
                { id: 'first_defense_visual', label: '第一防线', assetUrl: 'assets/map/composite/defense/first-defense.webp', rect: { x: 60, y: 94.7, w: 285, h: 116 }, filterIds: ['first_line', 'all'], hotspotIds: ['first_defense'] },
                { id: 'subway_visual', label: '隧道据点', assetUrl: 'assets/map/composite/defense/subway.webp', rect: { x: 360, y: 94.7, w: 270, h: 102 }, filterIds: ['first_line', 'all'], hotspotIds: ['subway'] },
                { id: 'alliance_dock_visual', label: '同盟卸货站', assetUrl: 'assets/map/composite/defense/alliance-dock.webp', rect: { x: 38.75, y: 260.4, w: 270, h: 128 }, filterIds: ['restricted', 'all'], hotspotIds: ['alliance_dock'] },
                { id: 'alliance_corridor_visual', label: '同盟通路', assetUrl: 'assets/map/composite/defense/alliance-corridor.webp', rect: { x: 46.4, y: 299.1, w: 277, h: 202 }, filterIds: ['restricted', 'all'], hotspotIds: ['alliance_corridor'] }
            ],
        ...
        school: {
            ...
            backgroundUrl: 'assets/map/page-school.webp',
            width: 1031,
            height: 608,
            sceneVisuals: [
                { id: 'workshop_visual', label: '大学地下工坊', assetUrl: 'assets/map/composite/school/workshop.webp', rect: { x: 423.05, y: 259.2, w: 147, h: 73 }, filterIds: ['inside', 'all'], hotspotIds: ['workshop'] },
                { id: 'union_university_visual', label: '联合大学', assetUrl: 'assets/map/composite/school/union-university.webp', rect: { x: 375.2, y: 443.2, w: 246.12, h: 106.9 }, filterIds: ['outside', 'all'], hotspotIds: ['union_university'] },
                { id: 'university_interior_visual', label: '大学内部', assetUrl: 'assets/map/composite/school/university-interior.webp', rect: { x: 364.15, y: 350.6, w: 189, h: 117 }, filterIds: ['inside', 'all'], hotspotIds: ['university_interior'] },
                { id: 'university_playground_visual', label: '大学操场', assetUrl: 'assets/map/composite/school/university-playground.webp', rect: { x: 591.85, y: 378.3, w: 193, h: 65 }, filterIds: ['inside', 'all'], hotspotIds: ['university_playground'] },
                { id: 'dorm_downstairs_visual', label: '大学宿舍楼下', assetUrl: 'assets/map/composite/school/dorm-downstairs.webp', rect: { x: 195.75, y: 340.25, w: 185, h: 105 }, filterIds: ['inside', 'all'], hotspotIds: ['dorm_downstairs'] },
                { id: 'school_dormitory_visual', label: '大学宿舍', assetUrl: 'assets/map/composite/school/school-dormitory.webp', rect: { x: 57.3, y: 276.35, w: 148, h: 85 }, filterIds: ['inside', 'all'], hotspotIds: ['school_dormitory'] },
                { id: 'office_visual', label: '教学楼办公室', assetUrl: 'assets/map/composite/school/office.webp', rect: { x: 412.15, y: 47.6, w: 132, h: 66 }, filterIds: ['inside', 'all'], hotspotIds: ['office'] },
                { id: 'kendo_club_visual', label: '剑道社', assetUrl: 'assets/map/composite/school/kendo-club.webp', rect: { x: 534.95, y: 160.5, w: 134, h: 68 }, filterIds: ['inside', 'all'], hotspotIds: ['kendo_club'] },
                { id: 'science_class_visual', label: '理科教室', assetUrl: 'assets/map/composite/school/science-class.webp', rect: { x: 681.75, y: 164.45, w: 67, h: 45 }, filterIds: ['inside', 'all'], hotspotIds: ['science_class'] },
                { id: 'arts_class_visual', label: '文科教室', assetUrl: 'assets/map/composite/school/arts-class.webp', rect: { x: 748.85, y: 164.45, w: 67, h: 45 }, filterIds: ['inside', 'all'], hotspotIds: ['arts_class'] },
                { id: 'teaching_interior_visual', label: '教学楼内部', assetUrl: 'assets/map/composite/school/teaching-interior.webp', rect: { x: 423.05, y: 201.75, w: 230.4, h: 76.4 }, filterIds: ['inside', 'all'], hotspotIds: ['teaching_interior'] },
                { id: 'teaching_right_visual', label: '教学楼内部右侧', assetUrl: 'assets/map/composite/school/teaching-right.webp', rect: { x: 652.95, y: 200.1, w: 162.49, h: 81.25 }, filterIds: ['inside', 'all'], hotspotIds: ['teaching_right'] }
            ],
            ...
            defaultFilterId: 'all',
            dynamicAvatars: [
                { id: 'roommate', label: '室友', kind: 'roommateGender', hotspotId: 'school_dormitory', relX: 20.7, relY: 17.65, w: 48, h: 48 }
            ],
            hotspots: [
