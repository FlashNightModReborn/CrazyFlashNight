...
--- parse 性能基准（等价路径 + 基线扣除） ---
  ...
  小(10项) | 895 字符
    JSON:         3.325 ms/次 | 40 次/轮 | 中位总 133.00 ms | 0.26 MB/s | 波动 1.04x
    LiteJSON:     0.823 ms/次 | 192 次/轮 | 中位总 158.00 ms | 1.04 MB/s | 波动 1.01x
    FastJSON(失配): 1.066 ms/次 | 8 批/轮 x32 = 256 次 | 中位总 273.00 ms | 0.80 MB/s | 波动 1.03x
    FastJSON(严冷): 1.063 ms/次 | 8 批/轮 x32 = 256 次 | 中位总 272.00 ms | 0.80 MB/s | 波动 1.04x
    FastJSON(热): 3.26 us/次 | 50000 次/轮 | 中位总 163.00 ms | 261.82 MB/s | 波动 1.02x
    --
    JSON / LiteJSON = 4.04x
    LiteJSON / FastJSON(严冷) = 0.77x
    FastJSON 严冷 / 失配 = 1.00x
    FastJSON 失配 / 热 = 327.12x
    FastJSON 严冷 / 热 = 325.92x

  中(50项) | 4035 字符
    JSON:         14.700 ms/次 | 10 次/轮 | 中位总 147.00 ms | 0.26 MB/s | 波动 1.01x
    LiteJSON:     3.719 ms/次 | 64 次/轮 | 中位总 238.00 ms | 1.03 MB/s | 波动 1.04x
    FastJSON(失配): 4.715 ms/次 | 4 批/轮 x64 = 256 次 | 中位总 1207.00 ms | 0.82 MB/s | 波动 1.03x
    FastJSON(严冷): 4.672 ms/次 | 4 批/轮 x64 = 256 次 | 中位总 1196.00 ms | 0.82 MB/s | 波动 1.03x
    FastJSON(热): 9.07 us/次 | 14336 次/轮 | 中位总 130.00 ms | 424.35 MB/s | 波动 1.07x
    --
    JSON / LiteJSON = 3.95x
    LiteJSON / FastJSON(严冷) = 0.80x
    FastJSON 严冷 / 失配 = 0.99x
    FastJSON 失配 / 热 = 519.94x
    FastJSON 严冷 / 热 = 515.20x

  大(200项) | 16244 字符
    JSON:         59.500 ms/次 | 4 次/轮 | 中位总 238.00 ms | 0.26 MB/s | 波动 1.06x
    LiteJSON:     14.813 ms/次 | 16 次/轮 | 中位总 237.00 ms | 1.05 MB/s | 波动 1.04x
    FastJSON(失配): 18.648 ms/次 | 2 批/轮 x64 = 128 次 | 中位总 2387.00 ms | 0.83 MB/s | 波动 1.01x
    FastJSON(严冷): 18.766 ms/次 | 2 批/轮 x64 = 128 次 | 中位总 2402.00 ms | 0.83 MB/s | 波动 1.01x
    FastJSON(热): 31.49 us/次 | 4096 次/轮 | 中位总 129.00 ms | 491.88 MB/s | 波动 1.07x
    --
    JSON / LiteJSON = 4.02x
    LiteJSON / FastJSON(严冷) = 0.79x
    FastJSON 严冷 / 失配 = 1.01x
    FastJSON 失配 / 热 = 592.12x
    FastJSON 严冷 / 热 = 595.84x
...
--- stringify 性能基准（等价路径 + 基线扣除） ---
  ...
  小(10项) | 约 895 输出字符
    ...
    LiteJSON:     3.91 us/次 | 32768 次/轮 | 中位总 128.00 ms | 218.51 MB/s | 波动 1.02x
    ...
    FastJSON(热): 2.86 us/次 | 50000 次/轮 | 中位总 143.00 ms | 298.44 MB/s | 波动 1.06x
    --
    JSON / LiteJSON = 0.25x
  ...
  中(50项) | 约 4035 输出字符
    JSON:         0.95 us/次 | 32768 次/轮 | 中位总 31.00 ms | 4067.54 MB/s | 波动 1.03x
    LiteJSON:     4.06 us/次 | 32768 次/轮 | 中位总 133.00 ms | 948.07 MB/s | 波动 1.05x
    FastJSON(失配): 7.60 us/次 | 512 批/轮 x64 = 32768 次 | 中位总 249.00 ms | 506.40 MB/s | 波动 1.05x
    FastJSON(严冷): 12.57 us/次 | 512 批/轮 x64 = 32768 次 | 中位总 412.00 ms | 306.05 MB/s | 波动 1.03x
    FastJSON(热): 2.83 us/次 | 30000 次/轮 | 中位总 85.00 ms | 1358.14 MB/s | 波动 1.11x
    --
    JSON / LiteJSON = 0.23x
    LiteJSON / FastJSON(严冷) = 0.32x
  ...
  大(200项) | 约 16244 输出字符
    ...
    FastJSON(失配): 7.54 us/次 | 512 批/轮 x64 = 32768 次 | 中位总 247.00 ms | 2055.16 MB/s | 波动 1.02x
    FastJSON(严冷): 12.29 us/次 | 384 批/轮 x64 = 24576 次 | 中位总 302.00 ms | 1260.66 MB/s | 波动 1.04x
    FastJSON(热): 2.75 us/次 | 12000 次/轮 | 中位总 33.00 ms | 5633.27 MB/s | 波动 1.19x
    --
...
--- FastJSON 缓存专项（中规模） ---
  ...
  parse
    失配: 4.832 ms/次 | 4 批/轮 x64 = 256 次 | 中位总 1237.00 ms | 0.80 MB/s | 波动 1.01x
    严冷: 4.852 ms/次 | 4 批/轮 x64 = 256 次 | 中位总 1242.00 ms | 0.79 MB/s | 波动 1.02x
    热: 9.00 us/次 | 14336 次/轮 | 中位总 129.00 ms | 427.64 MB/s | 波动 1.04x
    严冷 / 失配 = 1.00x
    失配 / 热 = 536.99x
    严冷 / 热 = 539.16x
  stringify
    失配: 7.43 us/次 | 768 批/轮 x64 = 49152 次 | 中位总 365.00 ms | 518.19 MB/s | 波动 1.02x
