...
(function() {
    ...
    // 沿用现有纸娃娃消费者的显式依赖顺序。CharacterAppearancePreview
    // 是全身预览（战斗 rig 合并取景）的共享包装，位于 renderer 之后。
    ...
    Panels.registerLazy('stage-select',
        ['modules/portrait-resolver.js',
         ...
         'modules/stage-select/stage-select-intel-data.js',
         'modules/stage-select/stage-select-focus.js',
         'modules/stage-select/stage-select-camera-editor.js',
    ...
    Panels.registerLazy('team',
        ['modules/workbench-lifecycle.js',
         ...
         'modules/merc/merc-loadout-drop-policy.js',
         'modules/merc/merc-loadout-channel.js',
