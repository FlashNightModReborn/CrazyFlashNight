...
开始增强版性能测试...
  测试数组大小: 1000
    ...
    mergeStress: 4ms
    gallopFriendly: 1ms
    gallopUnfriendly: 6ms
  测试数组大小: 5000
    random: 106ms
    sorted: 6ms
    reverse: 10ms
    partiallyOrdered: 77ms
    manyDuplicates: 79ms
    pianoKeys: 16ms
    organPipe: 15ms
    mergeStress: 20ms
    gallopFriendly: 11ms
    gallopUnfriendly: 36ms
  测试数组大小: 10000
    random: 229ms
    sorted: 11ms
    reverse: 14ms
    partiallyOrdered: 173ms
    manyDuplicates: 173ms
    pianoKeys: 38ms
    organPipe: 34ms
    mergeStress: 52ms
    gallopFriendly: 18ms
    gallopUnfriendly: 89ms
增强版性能测试完成
