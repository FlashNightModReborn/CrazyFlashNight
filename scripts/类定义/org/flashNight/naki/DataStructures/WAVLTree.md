...
搜索 100 个元素平均耗时: 0.65 毫秒
移除 100 个元素平均耗时: 1.47 毫秒
buildFromArray(100 个元素)平均耗时: 0.52 毫秒
changeCompareFunctionAndResort(100 个元素)平均耗时: 0.82 毫秒

容量: 1000，执行次数: 10
PASS: 所有元素移除后，size 应为0
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 WAVLTree 中
添加 1000 个元素平均耗时: 27.5 毫秒
搜索 1000 个元素平均耗时: 11.3 毫秒
移除 1000 个元素平均耗时: 18 毫秒
buildFromArray(1000 个元素)平均耗时: 5.7 毫秒
changeCompareFunctionAndResort(1000 个元素)平均耗时: 8.4 毫秒
...
移除 10000 个元素平均耗时: 263 毫秒
buildFromArray(10000 个元素)平均耗时: 59 毫秒
changeCompareFunctionAndResort(10000 个元素)平均耗时: 82 毫秒
