...
2026-07-29 的 B7 施工从 commit `c96f4c3d750561022b706c72a4d53050431e627d` 起步，后续实现进入 `9118eb5097…` 冻结源码与配对正式 runtime。当前工作树又在该 release 之后删除仓库、装备、NPC 商店、合成与技能教师的 legacy renderer/fallback，并收口 main XFL 可达闭包；因此下文关于 `9118eb…` 的 promotion 只保留为上一闭包的历史事实，不能把“旧字节已部署”改写成本轮新 cut 已完成 Character、Materials、Intelligence、PlayerInfo、业务写或持久化验证。本轮 fresh 自动门与 GUI 人工验收已通过，但尚未冻结新的 tag/request、形成云端共识、promotion、DLL 部署或标准入口复验，当前仍为 `NOT_DEPLOYED`。
