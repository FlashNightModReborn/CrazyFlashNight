...
**文档角色**：启动与运行自动化入口。  
**当前正式列车（2026-08-27，库存显式批量转移真批量事务）**：release source `5f5cfce7c162ba616bfc51f3c03f3134e937d36a`、tag `runtime-build-v2/20260827-inventory-batch-transfer-v1`、release tree `91e2378b4036f7cb6fdbdbe4aa15d656732b840b` 与 request `BA233DEDA6FC141F195C2F58E0D71C47872C0ADF309128E3D1B06BCBD127E774` 已由本地 X509 `builder-local-b` / `physical-host-b` 与 GitHub OIDC/Sigstore `github-hosted-windows`（cloud run `33032741729`）对 identity `E746A365F2715556A3298C4CBF1E926F039BC147625D4612F850768C9A52ADA3`、closure `8175440099ECF58708CD35F81F9C4A0B81390EC64EF2896D96EB885779A20475` 达成双 signer / 双 faultDomain 共识。39/39 final receipt SHA-256 为 `B8DB252CA30AF80DEC51D696810E557DA0B9CCC82C5DE7122E7F5C149439726C`；deployment commit `4d5fd254752a149ce07006f8f48391ab26485f61` 与 post-promotion audit run `33034014440` 均已推送/通过，审计明确输出 `state=promoted`、`deploymentChanged=true`。
无 candidate selector 的正式入口已确认 `formal_runtime`、正式 Core `69372E65CAB80D81A9448A41AA2167E8A7E707FB949CF57710BADC25118B16E2`、精确 identity/closure、同一 lifecycle 两次 verified status、新鲜 `bootstrap_reveal_ready`、可信 shutdown receipt、Flash code 0 与零 Flash/WebView2/hotkey guard 残留。第一次窄 smoke 的 trusted runner `exit 2` 未采信，第二次独立 fresh run 通过。维护者已接受大批物资即时完成，因此当前是库存批量转移 `HUMAN_ACCEPTANCE_PASSED / promoted`、正式入口身份/生命周期窄纵切 `standard_entry_verified`；正式入口没有重跑库存写或写后重启读回，不称业务或持久化 `standard_entry_verified`。
