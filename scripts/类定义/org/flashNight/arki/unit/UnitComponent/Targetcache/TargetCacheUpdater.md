...
✅ leftValues与实际坐标一致 PASS (expected=1250.05818060832, actual=1250.05818060832)
✅ rightValues与实际坐标一致 PASS (expected=1270.05818060832, actual=1270.05818060832)
✅ leftValues与实际坐标一致 PASS (expected=1250.27012591716, actual=1250.27012591716)
✅ rightValues与实际坐标一致 PASS (expected=1270.27012591716, actual=1270.27012591716)
✅ leftValues与实际坐标一致 PASS (expected=1250.32014843076, actual=1250.32014843076)
✅ rightValues与实际坐标一致 PASS (expected=1270.32014843076, actual=1270.32014843076)
✅ leftValues与实际坐标一致 PASS (expected=1250.68864738336, actual=1250.68864738336)
✅ rightValues与实际坐标一致 PASS (expected=1270.68864738336, actual=1270.68864738336)
✅ leftValues与实际坐标一致 PASS (expected=1250.84807277191, actual=1250.84807277191)
✅ rightValues与实际坐标一致 PASS (expected=1270.84807277191, actual=1270.84807277191)
✅ leftValues与实际坐标一致 PASS (expected=1250.88705227245, actual=1250.88705227245)
✅ rightValues与实际坐标一致 PASS (expected=1270.88705227245, actual=1270.88705227245)
✅ leftValues与实际坐标一致 PASS (expected=1251.17825684138, actual=1251.17825684138)
✅ rightValues与实际坐标一致 PASS (expected=1271.17825684138, actual=1271.17825684138)
✅ leftValues与实际坐标一致 PASS (expected=1251.24526763801, actual=1251.24526763801)
✅ rightValues与实际坐标一致 PASS (expected=1271.24526763801, actual=1271.24526763801)
✅ leftValues与实际坐标一致 PASS (expected=1251.27780409297, actual=1251.27780409297)
✅ rightValues与实际坐标一致 PASS (expected=1271.27780409297, actual=1271.27780409297)
✅ leftValues与实际坐标一致 PASS (expected=1251.28827544162, actual=1251.28827544162)
✅ rightValues与实际坐标一致 PASS (expected=1271.28827544162, actual=1271.28827544162)
✅ leftValues与实际坐标一致 PASS (expected=1251.31468352163, actual=1251.31468352163)
✅ rightValues与实际坐标一致 PASS (expected=1271.31468352163, actual=1271.31468352163)
✅ leftValues与实际坐标一致 PASS (expected=1251.33439536439, actual=1251.33439536439)
✅ rightValues与实际坐标一致 PASS (expected=1271.33439536439, actual=1271.33439536439)
✅ leftValues与实际坐标一致 PASS (expected=1251.52863928117, actual=1251.52863928117)
✅ rightValues与实际坐标一致 PASS (expected=1271.52863928117, actual=1271.52863928117)
✅ leftValues与实际坐标一致 PASS (expected=1251.69357950334, actual=1251.69357950334)
✅ rightValues与实际坐标一致 PASS (expected=1271.69357950334, actual=1271.69357950334)
✅ leftValues与实际坐标一致 PASS (expected=1251.77290331805, actual=1251.77290331805)
✅ rightValues与实际坐标一致 PASS (expected=1271.77290331805, actual=1271.77290331805)
✅ leftValues与实际坐标一致 PASS (expected=1251.84007164789, actual=1251.84007164789)
✅ rightValues与实际坐标一致 PASS (expected=1271.84007164789, actual=1271.84007164789)
✅ leftValues与实际坐标一致 PASS (expected=1251.86794252135, actual=1251.86794252135)
✅ rightValues与实际坐标一致 PASS (expected=1271.86794252135, actual=1271.86794252135)
✅ leftValues与实际坐标一致 PASS (expected=1251.98314878624, actual=1251.98314878624)
✅ rightValues与实际坐标一致 PASS (expected=1271.98314878624, actual=1271.98314878624)
✅ leftValues与实际坐标一致 PASS (expected=1251.98861464858, actual=1251.98861464858)
✅ rightValues与实际坐标一致 PASS (expected=1271.98861464858, actual=1271.98861464858)
✅ leftValues与实际坐标一致 PASS (expected=1252.02776799444, actual=1252.02776799444)
✅ rightValues与实际坐标一致 PASS (expected=1272.02776799444, actual=1272.02776799444)
✅ leftValues与实际坐标一致 PASS (expected=1252.1391969244, actual=1252.1391969244)
✅ rightValues与实际坐标一致 PASS (expected=1272.1391969244, actual=1272.1391969244)
✅ leftValues与实际坐标一致 PASS (expected=1252.20198329771, actual=1252.20198329771)
✅ rightValues与实际坐标一致 PASS (expected=1272.20198329771, actual=1272.20198329771)
✅ leftValues与实际坐标一致 PASS (expected=1252.41962018423, actual=1252.41962018423)
✅ rightValues与实际坐标一致 PASS (expected=1272.41962018423, actual=1272.41962018423)
✅ leftValues与实际坐标一致 PASS (expected=1252.50239052344, actual=1252.50239052344)
✅ rightValues与实际坐标一致 PASS (expected=1272.50239052344, actual=1272.50239052344)
✅ leftValues与实际坐标一致 PASS (expected=1252.71719378885, actual=1252.71719378885)
✅ rightValues与实际坐标一致 PASS (expected=1272.71719378885, actual=1272.71719378885)
✅ leftValues与实际坐标一致 PASS (expected=1252.77720514219, actual=1252.77720514219)
✅ rightValues与实际坐标一致 PASS (expected=1272.77720514219, actual=1272.77720514219)
✅ leftValues与实际坐标一致 PASS (expected=1252.78268144233, actual=1252.78268144233)
✅ rightValues与实际坐标一致 PASS (expected=1272.78268144233, actual=1272.78268144233)
✅ leftValues与实际坐标一致 PASS (expected=1252.92068352923, actual=1252.92068352923)
✅ rightValues与实际坐标一致 PASS (expected=1272.92068352923, actual=1272.92068352923)
✅ leftValues与实际坐标一致 PASS (expected=1252.94175394811, actual=1252.94175394811)
✅ rightValues与实际坐标一致 PASS (expected=1272.94175394811, actual=1272.94175394811)
✅ leftValues与实际坐标一致 PASS (expected=1253.00884348806, actual=1253.00884348806)
✅ rightValues与实际坐标一致 PASS (expected=1273.00884348806, actual=1273.00884348806)
✅ leftValues与实际坐标一致 PASS (expected=1253.02869356237, actual=1253.02869356237)
✅ rightValues与实际坐标一致 PASS (expected=1273.02869356237, actual=1273.02869356237)
✅ leftValues与实际坐标一致 PASS (expected=1253.04018295137, actual=1253.04018295137)
✅ rightValues与实际坐标一致 PASS (expected=1273.04018295137, actual=1273.04018295137)
✅ leftValues与实际坐标一致 PASS (expected=1253.15801864956, actual=1253.15801864956)
✅ rightValues与实际坐标一致 PASS (expected=1273.15801864956, actual=1273.15801864956)
✅ leftValues与实际坐标一致 PASS (expected=1253.58321137028, actual=1253.58321137028)
✅ rightValues与实际坐标一致 PASS (expected=1273.58321137028, actual=1273.58321137028)
✅ leftValues与实际坐标一致 PASS (expected=1253.67449535755, actual=1253.67449535755)
✅ rightValues与实际坐标一致 PASS (expected=1273.67449535755, actual=1273.67449535755)
✅ leftValues与实际坐标一致 PASS (expected=1253.73600780033, actual=1253.73600780033)
✅ rightValues与实际坐标一致 PASS (expected=1273.73600780033, actual=1273.73600780033)
✅ leftValues与实际坐标一致 PASS (expected=1253.77673432231, actual=1253.77673432231)
✅ rightValues与实际坐标一致 PASS (expected=1273.77673432231, actual=1273.77673432231)
✅ leftValues与实际坐标一致 PASS (expected=1253.83572042454, actual=1253.83572042454)
✅ rightValues与实际坐标一致 PASS (expected=1273.83572042454, actual=1273.83572042454)
✅ leftValues与实际坐标一致 PASS (expected=1253.86660810327, actual=1253.86660810327)
✅ rightValues与实际坐标一致 PASS (expected=1273.86660810327, actual=1273.86660810327)
✅ leftValues与实际坐标一致 PASS (expected=1253.87393863872, actual=1253.87393863872)
✅ rightValues与实际坐标一致 PASS (expected=1273.87393863872, actual=1273.87393863872)
✅ leftValues与实际坐标一致 PASS (expected=1253.88368846849, actual=1253.88368846849)
✅ rightValues与实际坐标一致 PASS (expected=1273.88368846849, actual=1273.88368846849)
✅ leftValues与实际坐标一致 PASS (expected=1253.89972348697, actual=1253.89972348697)
✅ rightValues与实际坐标一致 PASS (expected=1273.89972348697, actual=1273.89972348697)
✅ leftValues与实际坐标一致 PASS (expected=1253.96409559995, actual=1253.96409559995)
✅ rightValues与实际坐标一致 PASS (expected=1273.96409559995, actual=1273.96409559995)
✅ leftValues与实际坐标一致 PASS (expected=1254.00711033028, actual=1254.00711033028)
✅ rightValues与实际坐标一致 PASS (expected=1274.00711033028, actual=1274.00711033028)
✅ leftValues与实际坐标一致 PASS (expected=1254.0153047163, actual=1254.0153047163)
✅ rightValues与实际坐标一致 PASS (expected=1274.0153047163, actual=1274.0153047163)
✅ leftValues与实际坐标一致 PASS (expected=1254.1056883405, actual=1254.1056883405)
✅ rightValues与实际坐标一致 PASS (expected=1274.1056883405, actual=1274.1056883405)
✅ leftValues与实际坐标一致 PASS (expected=1254.41621029284, actual=1254.41621029284)
✅ rightValues与实际坐标一致 PASS (expected=1274.41621029284, actual=1274.41621029284)
✅ leftValues与实际坐标一致 PASS (expected=1254.54723374452, actual=1254.54723374452)
✅ rightValues与实际坐标一致 PASS (expected=1274.54723374452, actual=1274.54723374452)
✅ leftValues与实际坐标一致 PASS (expected=1254.81345652137, actual=1254.81345652137)
✅ rightValues与实际坐标一致 PASS (expected=1274.81345652137, actual=1274.81345652137)
✅ leftValues与实际坐标一致 PASS (expected=1254.9769244506, actual=1254.9769244506)
✅ rightValues与实际坐标一致 PASS (expected=1274.9769244506, actual=1274.9769244506)
...
⚡ 执行性能基准测试...
📊 updateCache性能: 100次调用耗时 150ms
✅ updateCache性能达标 PASS
📊 批量操作性能: 100次批量操作耗时 452ms
✅ 批量操作性能合理 PASS
📊 缓存池操作性能: 100次操作耗时 1ms
✅ 缓存池操作性能合理 PASS
📊 大数据集测试: 1000个单位处理耗时 191ms
✅ 大数据集处理时间合理 PASS
✅ 大数据集结果非空 PASS
✅ 大数据集数组长度一致 PASS (expected=1000, actual=1000)
📊 注册表收集性能: 50次收集耗时 88ms (avg 1.76ms)
📊 含500个噪声对象的世界, reconciliation耗时 3ms
...
✅ 变更前ENEMY版本=1 PASS (expected=1, actual=1)
✅ 变更前PLAYER版本=0 PASS (expected=0, actual=0)
✅ 变更后ENEMY桶=0 PASS (expected=0, actual=0)
✅ 变更后PLAYER桶=1 PASS (expected=1, actual=1)
✅ 变更后registryCount仍=1 PASS (expected=1, actual=1)
✅ 变更后ENEMY版本递增(旧桶被修改) PASS
✅ 变更后PLAYER版本递增(新桶被修改) PASS
✅ 重置前有注册表数据 PASS
...
✅ 批量添加后ENEMY版本=6 PASS (expected=6, actual=6)
✅ 批量添加后PLAYER版本=4 PASS (expected=4, actual=4)
...
✅ 批量移除敌人后ENEMY版本=12 PASS (expected=12, actual=12)
✅ 批量移除敌人后PLAYER版本不变=4 PASS (expected=4, actual=4)
✅ 自检通过（注册表一致） PASS
✅ 无注册表不一致警告 PASS
...
🔖 执行版本失效正确性测试...
✅ removeReg:注册后ENEMY版本=1 PASS (expected=1, actual=1)
✅ removeReg:注册后PLAYER版本=0 PASS (expected=0, actual=0)
✅ removeReg:移除时bump注册阵营ENEMY=2 PASS (expected=2, actual=2)
✅ removeReg:移除时不bump当前阵营PLAYER=0 PASS (expected=0, actual=0)
✅ batchRemoveReg:添加后ENEMY=4 PASS (expected=4, actual=4)
✅ batchRemoveReg:移除后ENEMY=8 PASS (expected=8, actual=8)
✅ batchRemoveReg:PLAYER不变=0 PASS (expected=0, actual=0)
✅ batchChange:初始ENEMY=3 PASS (expected=3, actual=3)
✅ batchChange:初始PLAYER=0 PASS (expected=0, actual=0)
✅ batchChange:ENEMY版本递增(旧桶被修改) PASS
✅ batchChange:PLAYER版本递增(新桶被修改) PASS
✅ reconcile版本刷新:即使总数不变版本也递增 PASS
...
⚡ 性能基准报告:
  updateCache: 1.5ms/次 (100次测试)
  batchOperations: 4.52ms/次 (100次测试)
  cachePoolOps: 0.01ms/次 (100次测试)
  largeDataset: 191ms/次 (1次测试)
  registryCollection: 1.76ms/次 (50次测试)
  memoryEfficiency: 2.9ms/次 (10次测试)
