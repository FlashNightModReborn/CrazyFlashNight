...
**文档角色**：启动与运行自动化入口。  
**当前正式列车（2026-08-26，打击伤害数字 C# 原生化）**：release source `1eaa51d2afec10c8c6a9bf5abe1ff20343208e19`、tag `runtime-build-v2/20260826-hit-numbers-csharp-v1`、release tree `9e30c52740f2c18e4fc3c732a571aa314e2fced3` 与 request `99FA28B523CB89C3F68B14DEBE2DEC4A1C6B6E2A966DBEB665F605753290890A` 已由本地 X509 `builder-local-a` / `physical-host-a` 与 GitHub OIDC/Sigstore `github-hosted-windows`（cloud run `32923040870`）对 identity `3B075D1FD1E429137253315E5B2095B4D3C942FE42D039E43D55C93625FDA187`、closure `8E25D01458A05334FF1CFF44CB9A1F0E8B1BCE6420A4DE21D41B4D648479CF1D` 达成双 signer / 双 faultDomain 共识。39/39 final receipt SHA-256 为 `096080A9620608D6CA1824D5E0D5DA09011A7E32D6204596D1F53A6A16098432`；deployment commit `cef2c8d227049248d5767a06e0bf57700931e0b2` 与 post-promotion audit run `32923796401` 均已推送/通过。
无 candidate selector 的 `automation/start.ps1` 已确认 `formal_runtime`、正式 Core `5D160A15ECD569D3582E8BD41768A33C99BE92910E283276C514C68DABABC4BB`、精确 identity/closure、bus ready、正常 Guardian shutdown 与零 Flash/WebView2/hotkey guard 残留。维护者已接受与该 Core 逐字节相同的 D8 隔离候选；因此当前是打击数字 `HUMAN_ACCEPTANCE_PASSED / promoted`、正式入口身份/生命周期窄纵切 `standard_entry_verified`，不称部署后未重跑的打击数字战斗业务 `standard_entry_verified`。
