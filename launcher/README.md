...
> **最后核对代码基线**：上游 `9e900762a6`（2026-07-17）+ 装备调制迁移检查点 `b9cbac4ddf`。当前同时纳入 Runtime 可复现构建、地图 WebP / Canvas 预算和 `equipment_tuning` Web workbench；高变动功能的真机结论与未闭合 Gate 以对应专题章节和 [验证矩阵](../agentsDoc/testing-guide.md) 为准，不在页首复制施工日志。
