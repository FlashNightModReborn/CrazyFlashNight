...
**最后核对代码基线**：上游基线 commit `b072f97841ccb30e167c14495241ae64d9054e22`（`origin/main`，2026-07-21 发布前复核），当前为其上的 `release/map-loot-20260721-final` 未 promotion 发布候选树；主线允许 native 源码 fast-forward 直推并由事后 Audit 报告 `source-ahead`，但这不构成正式 Core 部署证据。Skill、合成、双栏工作台与 runtime v2 的细分门以对应专题 canonical doc 为准。
