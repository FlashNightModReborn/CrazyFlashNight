...
【22. 性能测试】
单盾模式 vs Shield: AdaptiveShield 23ms, Shield 30ms (比率:0.77x)
扁平化 vs 委托: 扁平化 23ms, 委托 62ms (委托/扁平化:2.7x)
栈模式 vs ShieldStack: AdaptiveShield 81ms, ShieldStack 90ms (比率:0.9x)
模式切换(升级+降级): 1000次 749ms, 平均0.75ms/次
