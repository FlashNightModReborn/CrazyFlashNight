...
class org.flashNight.sara.primitives.Wheel extends CircleParticle {
							
	public var rp:RimParticle;
	private var coeffSlip:Number;				
	

	public function Wheel(x:Number, y:Number, r:Number, getParent:Function) {
	
		super(x, y, r, getParent);
	...
	public function dispose(e:DynamicsEngine):Void {
		// Dispose of the RimParticle
		if (rp) {
			rp.dispose();
			rp = null;
		}
		
		// Call the dispose method of the superclass (CircleParticle) to clean up inherited properties
		super.dispose(e);
		
		// Since coeffSlip is a primitive type, it doesn't require special disposal
	}
