...
**最后核对代码基线**：字体资产 Gate E release source commit `df7d7fd5e199da736ba0a1f8f50fa0aad39fba57`（tag `runtime-build-v2/20260821-font-gate-e-v1`）、release tree `dc873015785b35a1176ff454ce581b860f473392`、request `F3B8B8F6B30B871A7CADC307D273C3F60B6CA9BFE3FA99920A6693AB26411A3F` 已由本地 X509 `builder-local-b` / `physical-host-b` 与 GitHub OIDC/Sigstore `github-hosted-windows`（cloud run `32454968377`）完成 v2 双 signer/双故障域 promotion；正式 runtime 绑定 identity `31868EBA538A26C3D6200BBEBE450D9E6EC8CFC6AB08AF70AFD708644BFE36E8`、closure `13F29BBD5792A8D2D13272761FE150C70C303388A0EA5E443BFE1A956C9D4811`、Core SHA-256 `D970911DEBECB7EDAC1E9FAA631BF4FF5C0B55CF36DB85AEEC57363E08A4B029`，38/38 production receipt SHA-256 `BE4FC105F3005A3ED49233698674CA246335AF5A29D86CDD356749C8C2FDEBCB`；promotion commit `973dc8ab46fa8b627fe17c777eacfb4f62c918ee` 与 post-promotion audit run `32455849082` 均已推送/通过，审计明确输出 `state=promoted`、`deploymentChanged=true`。

**状态边界**：字体领域证据为 14 asset / 14 face / 28 role / 9 preset、fontctl 25/25、真实 Edge 字体矩阵 16/16、情报面板四档 DPI 各 30/30、Crafting 266/266、Equipment 504/504、KShop 249/249、NPC 149/149、Launcher 全量 3900 pass + 3 explicit opt-in skip / 3903 total、production policy 38/38、doc governance 与部署后 worktree/index 33-file bundle、consensus、根 bootstrap `--verify-only` 全通过。维护者已在发布前明示人工观感验收；但没有在 post-promotion formal runtime 重跑字体业务标准入口旅程，第三方字体也未取得正式法律意见。因此本列车称 `GATE_E_COMPLETE / promoted`，不称 `standard_entry_verified`；Flash / FLA / XFL 作者字体治理仍明确排除，旧列车明细统一留在 [runtime-build-reproducibility.md](docs/runtime-build-reproducibility.md)，Audio H2 继续作为专项 `pending`。
