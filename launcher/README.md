...
> **2026-08-15 Audio 发布列车当前态**：source `48c312234ab189b16f9edd2f5f7b0b2e78fc1407` / tree `effd7c33f4623dd2dbae596d58cc9b8a08b6a072` 已由 request `00D6B5445138406C643BF62FD1270BB9F15938D4D8B37F6D1F5360FC6BEC9405`、本地 X509 `physical-host-b` 与 GitHub OIDC/Sigstore `github-hosted-windows` 完成双 signer / 双 faultDomain v2 promotion；正式 identity 为 `50538C0BA1516E1BA09AE86BB94B2C885A02C106C5EB6FBAA806C47AFFB5CB4A`，closure 为 `FE874BA9CAC43B4ED944A1B5606DFDD03176C02A89F510338CEC251B2C768793`。该列车使用 owner-emergency 明示旁路，Audio E1/H2/E3 未满足且未伪造；正式入口只证明同身份启动、优雅退出与零残留，严格为 `promoted / standard_entry_verified=false`。正常 H2 合规路径仍保持开放。
...
> **最后核对架构与工作流**：current formal release source commit `48c312234ab189b16f9edd2f5f7b0b2e78fc1407`、release tree `effd7c33f4623dd2dbae596d58cc9b8a08b6a072`、request `00D6B5445138406C643BF62FD1270BB9F15938D4D8B37F6D1F5360FC6BEC9405`，已由本地 X509 `physical-host-b` 与 GitHub OIDC/Sigstore `github-hosted-windows` 完成双 signer / 双 faultDomain v2 promotion；正式 runtime 绑定 identity `50538C0BA1516E1BA09AE86BB94B2C885A02C106C5EB6FBAA806C47AFFB5CB4A`、closure `FE874BA9CAC43B4ED944A1B5606DFDD03176C02A89F510338CEC251B2C768793`。本轮 owner-emergency 路径明确 bypass Audio E1/H2/E3；正式入口只有 `runtimeMode=formal_runtime / FORMAL_RUNTIME` 身份 smoke、优雅退出与零残留，不声称 H2、完整 Audio 专项纵切或 `standard_entry_verified`。P4/H4 仍是 H2 合规路线的合同底座，不被 emergency promotion 改写；此前跨层回包、P4/P5、A1–A6 与 F8 release 只保留为历史分层。通用判定见 [验证矩阵](../agentsDoc/testing-guide.md)。
