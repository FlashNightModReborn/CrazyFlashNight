...
- **钛合金61式套装玩法**：[钛合金61式装甲套装玩法设计 ADR](../docs/钛合金61式装甲套装-玩法设计-ADR-2026-07-27.md)（五件防具门控；MP驱动护盾/维生/双枪补弹；P90发射发电；M134/P90/血剑/钛合金QJZ171机制亲和；太空基地低重力设定与-17kg火控恢复；高级夜视与应急自动注射边界）；[原型建模](../docs/钛合金61式套装-原型建模-2026-09-08.md)记录剑圣50+实测档位、牙狼对照、合法槽位及玻璃大炮的能源/生存约束。
...
- **超级材料与工程遗产**：[统合时期的超级材料学](../docs/worldbuilding/21-统合时期的超级材料学.md)（材料性能与工艺、昂贵特装到普及、末世制造瓶颈；钛基材料和61系为首个完整案例，后续同类材料沿此入口补建）。
...
- **三维选关空间设计**：[创作与交接经验](../docs/三维选关场景创作与交接经验.md)（黑铁会总部案例：剧情批次与空间交通、设施职能与台地、双层仪式空间、攻击审阅裁决、默认镜头及标签辨识；具体采用布局仍归 R7 工单）。
