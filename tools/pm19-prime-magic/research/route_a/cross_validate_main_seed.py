...
SEED_JSON = ROOT / "prime-magic-19" / "seeds" / "prime_magic_19_seed_00.json"
SEED_BIN = ROOT / "prime-magic-19" / "seeds" / "prime_magic_19_seed_00.bin"
...
def main() -> None:
    ...
    (HERE / "main_seed00_cross_validation.json").write_text(json.dumps(report, indent=2) + "\n")
