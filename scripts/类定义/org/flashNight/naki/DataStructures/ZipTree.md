...
添加 100 个元素平均耗时: 2.28 毫秒
搜索 100 个元素平均耗时: 2.63 毫秒
移除 100 个元素平均耗时: 2.43 毫秒
buildFromArray(100 个元素)平均耗时: 2.51 毫秒
changeCompareFunctionAndResort(100 个元素)平均耗时: 2.82 毫秒

容量: 1000，执行次数: 10
PASS: 所有元素移除后，size 应为0
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 ZipTree 中
添加 1000 个元素平均耗时: 33.9 毫秒
搜索 1000 个元素平均耗时: 49.3 毫秒
移除 1000 个元素平均耗时: 46.1 毫秒
buildFromArray(1000 个元素)平均耗时: 34.6 毫秒
changeCompareFunctionAndResort(1000 个元素)平均耗时: 35.7 毫秒

容量: 10000，执行次数: 1
PASS: 所有元素移除后，size 应为0
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 ZipTree 中
添加 10000 个元素平均耗时: 429 毫秒
搜索 10000 个元素平均耗时: 575 毫秒
移除 10000 个元素平均耗时: 417 毫秒
buildFromArray(10000 个元素)平均耗时: 408 毫秒
changeCompareFunctionAndResort(10000 个元素)平均耗时: 356 毫秒
...
|------|-----|-----|------|-----|----------|
| 添加 | 591 | 1556 | 391 | **284** | 最快 |
| 搜索 | 213 | 216 | **163** | 462 | 较慢 |
| 删除 | 277 | 3440 | **268** | 397 | 中等 |
| 总计 | 1081 | 5212 | **822** | 1143 | 中等 |

#### Zip Tree 性能特点

**优势**:
- **插入最快**: 284ms，比 WAVL 快 28%，比 AVL 快 52%
- **实现简单**: 无需复杂的旋转逻辑，代码量最少
- **并发友好**: 结构变化局部性好

**劣势**:
- **搜索较慢**: 462ms，比 WAVL 慢 183%
...
ZipTree 在 AS2 环境下提供了一个实现简洁的随机化平衡树：
