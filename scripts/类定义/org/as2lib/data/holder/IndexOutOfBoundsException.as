...
/**
 * {@code IndexOutOfBoundsException} is thrown to indicate that an index is out of
 * range.
 * 
 * @author Simon Wacker
 */
class org.as2lib.data.holder.IndexOutOfBoundsException extends DataHolderException {
	
	/**
	 * Constructs a new {@code IndexOutOfBoundsException} instance.
	 * 
	 ...
	 */
	public function IndexOutOfBoundsException(message:String, thrower, args:Array) {
