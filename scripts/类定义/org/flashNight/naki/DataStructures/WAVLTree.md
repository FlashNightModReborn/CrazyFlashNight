...
添加 100 个元素平均耗时: 2.51 毫秒
搜索 100 个元素平均耗时: 0.72 毫秒
移除 100 个元素平均耗时: 1.63 毫秒
buildFromArray(100 个元素)平均耗时: 0.7 毫秒
changeCompareFunctionAndResort(100 个元素)平均耗时: 0.85 毫秒

容量: 1000，执行次数: 10
PASS: 所有元素移除后，size 应为0
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 WAVLTree 中
添加 1000 个元素平均耗时: 35.6 毫秒
搜索 1000 个元素平均耗时: 10.5 毫秒
移除 1000 个元素平均耗时: 29 毫秒
...
PASS: 所有添加的元素都应成功移除
PASS: 所有添加的元素都应存在于 WAVLTree 中
添加 10000 个元素平均耗时: 462 毫秒
搜索 10000 个元素平均耗时: 155 毫秒
移除 10000 个元素平均耗时: 434 毫秒
