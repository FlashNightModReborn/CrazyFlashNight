...
> **当前退役 cut（2026-07-30）**：旧 AS2 工作台 fallback、Skill 无 token 兼容与主文件 legacy UI 资产可达性已经移除，GUI 人工验收已通过。当前仍未冻结新的 tag/request，未形成双 signer / 双 faultDomain quorum，未 promotion，也未从标准入口复验，因此状态仍为 `NOT_DEPLOYED`；不得把上面的 `9118eb…` 历史 release 身份拼接成当前 cut 已部署。
