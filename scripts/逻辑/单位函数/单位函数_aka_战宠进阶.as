...
_root.战宠进阶函数.弹射弧光斩 = {
	...
	背景:"装备",
	详情页描述:function(){
		var 基础介绍 = "对键盘的武器进行强化升级，提高攻击力，并解锁招式弹射弧光斩。同时，部分招式的攻击速度将会提高。"
		if(this.当前宠物信息[1] < this.进阶方案.弹射弧光斩.解锁等级){
...
_root.战宠进阶函数.导弹烈炎炮 = {
	...
	背景:"装备",
	详情页描述:function(){
		var 基础介绍 = "对吉他的武器进行强化升级，提高攻击力，并解锁招式导弹烈炎炮。并且在防御力叠加达到三倍后可能开启嘲讽演出，吸引全场敌方攻击并恢复友军生命。"
		if(this.当前宠物信息[1] < this.进阶方案.导弹烈炎炮.解锁等级){
...
_root.战宠进阶函数.常驻淬毒 = {
	进阶类型:"开关", // 纯开关：消耗金币是"每张图"运行时扣费而非升级价，永不"完成"、无前置购买
	初始化:null,
	消耗金币:500,
	消耗K点:0,
	效果:70,
...
_root.战宠进阶函数.复仇者 = {
	...
	描述:function(){
		...
		return "点击可领悟招式，提高攻防并解锁新招式，需要消耗"+ this.进阶方案.复仇者.消耗金币+"金币";
	},
	详情页:true,
	执行按钮文字:"领悟招式",
	背景:"超能",
...
_root.战宠进阶函数.抱头嘲讽 = {
	...
	描述:function(){
		if(this.当前宠物信息[1] < this.进阶方案.抱头嘲讽.解锁等级){
			return this.进阶方案.抱头嘲讽.解锁等级 + "级以上可以领悟招式，解锁"+this.进阶方案.抱头嘲讽.名称
		}
		if(this.当前宠物属性.抱头嘲讽){
			return "已领悟招式"
		}
		return "点击可领悟招式，提高防御与hp并解锁新招式，需要消耗"+ this.进阶方案.抱头嘲讽.消耗金币+"金币";
	},
	详情页:true,
	执行按钮文字:"领悟招式",
	背景:"超能",
	详情页描述:function(){
		var 基础介绍 = "提高它的智力水平，从而能够主动进入防御姿态，并发出吼声吸引敌方攻击。<br>同时进一步强化肉体强度。<br>提升防御力、hp，并解锁招式"+this.进阶方案.抱头嘲讽.名称+"，可主动使用，抱头期间大幅提高防御力并产生嘲讽效果。"
		if(this.当前宠物信息[1] < this.进阶方案.抱头嘲讽.解锁等级){
			return 基础介绍 + "<br>"+this.进阶方案.抱头嘲讽.解锁等级+"级以上可以领悟招式。"
		}
		if(this.当前宠物属性.抱头嘲讽){
			return 基础介绍 + "<br>当前已领悟该招式。"
		}
		return 基础介绍 + "<br>领悟招式需要消耗"+ this.进阶方案.抱头嘲讽.消耗金币+"金币。";
	},
	条件:function(){
		if( this.当前宠物信息[1] < this.进阶方案.抱头嘲讽.解锁等级){
			this.失败提示 = "";
