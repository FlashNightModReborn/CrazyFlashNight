...
**最后核对代码基线**：release source commit `c59b9b4cdb9319c04503a703019a9dff30bc04a1`（2026-09-08；tag `runtime-build-v2/20260908-plastic-surgery-v1`）。医务室整形 Web 迁移、共享外观预览及旧整形资源删除已完成双 signer / 双故障域共识、40/40 production policy 和原子 promotion，当前为 `HUMAN_ACCEPTANCE_PASSED / promoted`（限维护者确认的画面、新医务室入口及候选日志中的扣费保存与余额不足拒绝）。完整身份见 [runtime-build-reproducibility.md](docs/runtime-build-reproducibility.md)，功能和验收边界见[整形说明](docs/医务室整形-Web面板与外观共享-2026-09-08.md)；合并上游后的正式产物未重跑游戏业务，不外推 `standard_entry_verified`。选关前台交接、返回重试与地图中途撤退的既有结论保持原范围，见[焦点诊断 §9.13](docs/焦点管理-诊断与卡顿排查-2026-05-24.md#913-2026-09-08选关关闭前的前台交接)、[关卡结果 ADR §0C/§0D](docs/关卡结果与基地结算-CSharp-Web-ADR-2026-08-27.md)；地图工作台第二阶段见[两阶段记录](docs/地图工作台与CSharp收束-两阶段施工-2026-09-06.md)。
