...
> **最后核对架构与工作流**：current formal release source commit `704d836f42b70f788db8b5b2151c8ab3dcf77792`、release tree `c4581f1ed445840ce6d648a842c65b113509c20c`、tag `runtime-build-v2/20260815-panel-wire-minimal-gate-v1`、request `CC8C3E614F3B38CA75F2868BE6DDE6A49891EFA8E9EED7E8B23E291DBBA62306`、deployment commit `019cf8d0d253adc23578f8d2ad0042067866dec2`；双 signer / 双 faultDomain v2 promotion 已绑定 identity `BB77F46E18C253AD66AF9DA6E89E9E254D7798FC7FAFEC2D520A8E7D3D72595E` 与 closure `25DD44F37E3936D11D5A281200F72FE68A1833A288B678A0520F64A4CBC49660`，cloud build run `31886952236`、post-promotion audit run `31888427406` 均通过。Audio H2 仍为专项 `pending`，但不再是通用 supply-chain promotion 的门或 emergency bypass 来源；正式根入口 `--verify-only` 已通过，业务专项正式旅程未执行。此前发布列车只保留为历史分层。通用判定见 [验证矩阵](../agentsDoc/testing-guide.md)。
