...
**最后核对代码基线**：装备调制属性前后对比 source commit `167d929a4bc3a85d6d21cc7faa220644eefe01d7`（tag `runtime-build-v2/20260815-equipment-tuning-stats-v1`）、release tree `fd7c371587d39c9aec81c5d71fbaa03143e17652`、request `9152583BE0F4E379F157AAA4EB74D56EA6EEF17676D7B18B8984A93E849EEB29` 已由本地 X509 `physical-host-a` 与 GitHub OIDC/Sigstore `github-hosted-windows`（run `31881405907`）完成 v2 双 signer/双故障域 promotion；正式 runtime 绑定 identity `BD3E2D68C98E9EDFBCED8AB9B756A25FF4B15A54C5892169055085257ED9171A`、closure `07C04381D8EB5EE6A37FCC354E12F87931CB16A84B43BF4BC62653AE755FD7A1`、Core SHA-256 `7236654F6297BA1FBB5654F0515575C617599CFF7AE45F495C46F429138C175A`，promotion 提交 `9b1fe531b042d53207a0b879de71e394d1de8209`。本列车同为 owner 明确授权的 `owner_emergency_non_h2`（授权 SHA `D2E0894743DFC7146B1E128C929E857FB6CC1BBA8CDAA683CF4C069767B29F00`）：没有生成或伪造 Audio E1/H2/E3，但仍保留 immutable request、production policy、strict v2 verifier、atomic promotion 与 rollback；正式入口复验取得 `formal_runtime` 启动、正式 Core 路径/SHA 一致与总线就绪，业务面板实测由维护者目视进行，不冒称 `standard_entry_verified`。此前 Audio Platform v2 emergency `48c312234ab189b16f9edd2f5f7b0b2e78fc1407`、跨层回包键 `a87be26f1d6e80c0ea8883bbc10e46c895c35799`、竞技场 P4/P5、商城旧档、双栏工作台、F8 与 F7 C1 均只保留为历史分层证据。
