#!/usr/bin/env python3
"""Apply a frozen post-crop flip to a bounded large-frame human render."""
...
def load_base():
    spec = importlib.util.spec_from_file_location(
        "portrait_guided_orientation_large_frame_base", BASE_CONTROLLER
    )
...
def main() -> None:
    ...
    try:
        ...
        print(f"portrait guided orientation large-frame error: {error}", file=sys.stderr)
