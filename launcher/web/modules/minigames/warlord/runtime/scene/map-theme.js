const FACTION_STYLE_PALETTE = Object.freeze([
...
const DEMO_FACTION_STYLE_INDEX = Object.freeze({
    red: 0,
    blue: 1,
    player: 0,
    'boss-pact-a': 1,
...
function stableFactionHash(factionId) {
    let hash = 2166136261;
 ...
 */
export function factionVisualStyle(factionId) {
