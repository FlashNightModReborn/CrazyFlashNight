...
/**
 * {@code OverloadException} is the base exception of Overloading API.
 * 
 * <p>All exceptions of the Overloading API extend it.
 *
 * @author Simon Wacker
 */
class org.as2lib.env.overload.OverloadException extends FatalException {
	...
	/**
	 * Constructs a new {@code OverloadException} instance.
	 * 
